var M=Object.defineProperty,k=Object.defineProperties;var D=Object.getOwnPropertyDescriptors;var E=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable;var b=(n,e,t)=>e in n?M(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,w=(n,e)=>{for(var t in e||(e={}))P.call(e,t)&&b(n,t,e[t]);if(E)for(var t of E(e))N.call(e,t)&&b(n,t,e[t]);return n},C=(n,e)=>k(n,D(e));var a=(n,e,t)=>b(n,typeof e!="symbol"?e+"":e,t);var g=(n,e,t)=>new Promise((i,s)=>{var l=d=>{try{c(t.next(d))}catch(h){s(h)}},r=d=>{try{c(t.throw(d))}catch(h){s(h)}},c=d=>d.done?i(d.value):Promise.resolve(d.value).then(l,r);c((t=t.apply(n,e)).next())});(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(s){if(s.ep)return;s.ep=!0;const l=t(s);fetch(s.href,l)}})();const O="modulepreload",V=function(n){return"/capibara/"+n},S={},L=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){let h=function(m){return Promise.all(m.map(p=>Promise.resolve(p).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};var r=h;document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));s=h(t.map(m=>{if(m=V(m),m in S)return;S[m]=!0;const p=m.endsWith(".css"),y=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${y}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":O,p||(u.as="script"),u.crossOrigin="",u.href=m,d&&u.setAttribute("nonce",d),document.head.appendChild(u),p)return new Promise((T,A)=>{u.addEventListener("load",T),u.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${m}`)))})}))}function l(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return s.then(c=>{for(const d of c||[])d.status==="rejected"&&l(d.reason);return e().catch(l)})},H=n=>{let e;const t=new Set,i=(h,m)=>{const p=typeof h=="function"?h(e):h;if(!Object.is(p,e)){const y=e;e=(m!=null?m:typeof p!="object"||p===null)?p:Object.assign({},e,p),t.forEach(u=>u(e,y))}},s=()=>e,c={setState:i,getState:s,getInitialState:()=>d,subscribe:h=>(t.add(h),()=>t.delete(h))},d=e=n(i,s,c);return c},I=(n=>H);class o{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const i=this.getCapybaraWidth(),s=this.getCapybaraHeight(),l=this.getCapybaraBottom();return{x:e,y:t-l-s,width:i,height:s}}static calculateFillPercentage(e){return Math.min(100,e/this.LEVEL_UP_THRESHOLD*100)}static getPointsForLevelUp(){return this.LEVEL_UP_THRESHOLD}}a(o,"MOBILE_BREAKPOINT",768),a(o,"CAPYBARA_WIDTH_DESKTOP",100),a(o,"CAPYBARA_HEIGHT_DESKTOP",75),a(o,"CAPYBARA_WIDTH_MOBILE",100),a(o,"CAPYBARA_HEIGHT_MOBILE",75),a(o,"CAPYBARA_BOTTOM_DESKTOP",20),a(o,"CAPYBARA_BOTTOM_MOBILE",10),a(o,"VEGETABLE_SIZE_DESKTOP",50),a(o,"VEGETABLE_SIZE_MOBILE",40),a(o,"PLAYER_SPEED",8),a(o,"SPAWN_RATE_BASE",2e3),a(o,"SPAWN_RATE_DECREASE",100),a(o,"MIN_SPAWN_RATE",800),a(o,"LEVEL_UP_THRESHOLD",50),a(o,"AUDIO_ENABLED_DEFAULT",!0),a(o,"MASTER_VOLUME",.6),a(o,"ANIMATION_DURATION_FAST",300),a(o,"ANIMATION_DURATION_NORMAL",600),a(o,"ANIMATION_DURATION_SLOW",1e3),a(o,"REDUCE_ANIMATIONS",!1);const B=I()(n=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100,incrementLevel:()=>n(e=>({level:e.level+1,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>n(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>n(t=>{const i=t.score+e,s=t.capybaraFillPercentage+e,l=s>=o.LEVEL_UP_THRESHOLD;return{score:i,capybaraFillPercentage:l?o.LEVEL_UP_THRESHOLD:s,gameStatus:l?"won":t.gameStatus}}),resetForNextLevel:()=>n(()=>({capybaraFillPercentage:0,missedVegetables:0,gameStatus:"playing"})),resetGame:()=>n(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100})),pauseGame:()=>n(()=>({gameStatus:"paused"})),resumeGame:()=>n(()=>({gameStatus:"playing"}))}));class R{constructor(){a(this,"level",1);a(this,"score",0);a(this,"missedVegetables",0);a(this,"capybaraFillPercentage",0);a(this,"gameStatus","playing");a(this,"fallSpeed",2);a(this,"ceilingHeight",100);a(this,"vegetables",[]);a(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const x=new R;class Q{constructor(e){a(this,"element");a(this,"fillElement");a(this,"svgElement");a(this,"x",0);a(this,"lastX",0);a(this,"gameContainer");a(this,"speed",8);a(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-o.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
      position: absolute;
      bottom: 0;
      left: 0;
      width: 100%;
    ...
    `,this.element.addEventListener("click",()=>g(this,null,function*(){yield this.audioManager.init(),this.audioManager.play("click");const e=this.audioManager.toggle();this.element.innerHTML=e?"🔊":"🔇",this.element.style.opacity=e?"1":"0.6"})),this.element.addEventListener("mouseenter",()=>{this.element.style.transform="scale(1.1)"}),this.element.addEventListener("mouseleave",()=>{this.element.style.transform="scale(1)"})}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class Y{constructor(e){a(this,"container");a(this,"player");a(this,"spawner");a(this,"particles");a(this,"hud");a(this,"gameOverScreen");a(this,"levelTransition");a(this,"pauseOverlay");a(this,"helpModal");a(this,"audioToggle");a(this,"audioManager",f.getInstance());a(this,"animationId",0);a(this,"lastTime",0);a(this,"vegetables",[]);a(this,"gameStore",B);a(this,"levelTransitionActive",!1);this.container=e,this.init()}init(){this.player=new Q(this.container),this.spawner=new W(this.container),this.particles=new q(this.container),this.hud=new $(this.container),this.gameOverScreen=new z(this.container,()=>this.restart()),this.levelTransition=new G(this.container),this.pauseOverlay=new U(this.container,()=>this.helpModal.show()),this.helpModal=new F,this.audioToggle=new K(document.body),B.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"&&!this.levelTransitionActive?(this.levelTransitionActive=!0,this.audioManager.play("levelup"),this.levelTransition.show(e.level+1),this.clearAllVegetables(),setTimeout(()=>{this.gameStore.getState().incrementLevel(),this.gameStore.getState().resetForNextLevel(),this.levelTransitionActive=!1},2e3)):e.gameStatus==="lost"&&(this.audioManager.play("gameover"),this.gameOverScreen.show(!1,e.score,e.level))}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const i=this.gameStore.getState();(i.gameStatus==="lost"||i.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const i=this.gameStore.getState();i.gameStatus==="playing"?(this.update(t),this.render()):i.gameStatus,this.animationId=requestAnimationFrame(s=>this.gameLoop(s))}update(e){const t=this.gameStore.getState(),i=this.spawner.update(e,t.level);this.vegetables.push(...i),this.vegetables=this.vegetables.filter(r=>{const c=r.y+r.speed,d=this.player.getBounds();if(this.checkCollision(d,C(w({},r),{y:c}))){this.audioManager.play("catch"),t.updateScore(r.points),this.particles.createCatchEffect(r.x,c),this.spawner.removeVegetable(r.id);const h=this.container.querySelector(".capybara-player");return h&&(h.classList.add("capybara-player--catch"),setTimeout(()=>{h.classList.remove("capybara-player--catch")},600)),this.createScorePopup(r.x,c,r.points),!1}return c>this.container.clientHeight?(this.audioManager.play("miss"),t.incrementMissed(),this.spawner.removeVegetable(r.id),!1):(r.y=c,this.spawner.updateVegetablePosition(r),!0)}),this.particles.update();const s=this.gameStore.getState();this.hud.updateScore(s.score),this.hud.updateLevel(s.level),this.hud.updateLives(3-s.missedVegetables);const l=o.calculateFillPercentage(s.capybaraFillPercentage);this.hud.updateProgress(l),this.player.updateFill(l)}render(){this.particles.render()}checkCollision(e,t){const i=o.getVegetableSize(),s=.3,l=Math.max(0,Math.min(e.x+e.width,t.x+i)-Math.max(e.x,t.x)),r=Math.max(0,Math.min(e.y+e.height,t.y+i)-Math.max(e.y,t.y)),d=Math.min(e.width*e.height,i*i)*s;return l*r>=d}clearAllVegetables(){this.vegetables.forEach(e=>{this.spawner.removeVegetable(e.id)}),this.vegetables=[],this.spawner.reset()}restart(){this.clearAllVegetables(),this.gameStore.getState().resetGame(),this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}createScorePopup(e,t,i){const s=document.createElement("div");s.className="score-popup",s.textContent=`+${i}`,s.style.cssText=`
      position: absolute;
      left: ${e}px;
      top: ${t}px;
      color: #FFD700;
      ...
      pointer-events: none;
      z-index: 1000;
    `,this.container.appendChild(s),setTimeout(()=>{s.parentNode&&s.parentNode.removeChild(s)},1e3)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy(),this.audioToggle.destroy()}}class X{constructor(){a(this,"gameEngine",null);a(this,"container");a(this,"helpModal");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.helpModal=new F,this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),i=e.querySelector("#helpButton"),s=()=>{e.remove(),this.startGame()};t.addEventListener("click",()=>g(this,null,function*(){yield(yield L(()=>g(this,null,function*(){const{AudioManager:r}=yield Promise.resolve().then(()=>_);return{AudioManager:r}}),void 0)).AudioManager.getInstance().init(),s()})),t.addEventListener("touchend",l=>g(this,null,function*(){l.preventDefault(),yield(yield L(()=>g(this,null,function*(){const{AudioManager:c}=yield Promise.resolve().then(()=>_);return{AudioManager:c}}),void 0)).AudioManager.getInstance().init(),s()})),i.addEventListener("click",()=>{this.helpModal.show()}),t.addEventListener("click",()=>{}),i.addEventListener("click",()=>{}),e.addEventListener("touchmove",l=>{l.preventDefault()}),e.addEventListener("click",l=>{l.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new Y(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new X});window.addEventListener("resize",()=>{const n=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");n&&e&&(n.width=e.clientWidth,n.height=e.clientHeight)});
