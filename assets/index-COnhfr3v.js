var p=Object.defineProperty;var y=(n,e,t)=>e in n?p(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var s=(n,e,t)=>y(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const a of l)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const a={};return l.integrity&&(a.integrity=l.integrity),l.referrerPolicy&&(a.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?a.credentials="include":l.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(l){if(l.ep)return;l.ep=!0;const a=t(l);fetch(l.href,a)}})();class u{constructor(){s(this,"level",1);s(this,"score",0);s(this,"missedVegetables",0);s(this,"capybaraFillPercentage",0);s(this,"gameStatus","playing");s(this,"fallSpeed",2);s(this,"ceilingHeight",100);s(this,"vegetables",[]);s(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const r=new u;class g{constructor(e){s(this,"element");s(this,"fillElement");s(this,"svgElement");s(this,"x",0);s(this,"lastX",0);s(this,"gameContainer");s(this,"speed",8);s(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-50,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),i=()=>{this.hide(),e()};t.addEventListener("click",i),t.addEventListener("touchend",a=>{a.preventDefault(),i()});const l=a=>{a.code==="Space"&&(a.preventDefault(),i(),document.removeEventListener("keydown",l))};document.addEventListener("keydown",l)}}class C{constructor(e){s(this,"container");s(this,"player");s(this,"spawner");s(this,"particles");s(this,"hud");s(this,"gameOverScreen");s(this,"levelTransition");s(this,"pauseOverlay");s(this,"animationId",0);s(this,"lastTime",0);s(this,"vegetables",[]);this.container=e,this.init()}init(){this.player=new g(this.container),this.spawner=new f(this.container),this.particles=new v(this.container),this.hud=new x(this.container),this.gameOverScreen=new w(this.container,()=>this.restart()),this.levelTransition=new b(this.container),this.pauseOverlay=new E(this.container),r.addListener(()=>this.handleGameStateChange()),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(){r.gameStatus==="paused"?this.pauseOverlay.show(()=>r.resumeGame()):r.gameStatus==="playing"?this.pauseOverlay.hide():r.gameStatus==="won"?(this.levelTransition.show(r.level),setTimeout(()=>{r.resetForNextLevel(),r.gameStatus="playing"},2e3)):r.gameStatus==="lost"&&this.gameOverScreen.show(!1,r.score,r.level)}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault(),r.gameStatus==="playing"?r.pauseGame():r.gameStatus==="paused"&&r.resumeGame();break;case"r":case"R":(r.gameStatus==="lost"||r.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e,r.gameStatus==="playing"?(this.update(t),this.render()):r.gameStatus,this.animationId=requestAnimationFrame(i=>this.gameLoop(i))}update(e){const t=this.spawner.update(e,r.level);this.vegetables.push(...t),this.vegetables=this.vegetables.filter(i=>{i.y+=i.speed,this.spawner.updateVegetablePosition(i);const l=this.player.getBounds();if(this.checkCollision(l,i)){r.updateScore(i.points),this.particles.createCatchEffect(i.x,i.y),this.spawner.removeVegetable(i.id);const a=this.container.querySelector(".capybara-player");return a&&(a.classList.add("capybara-player--catch"),setTimeout(()=>{a.classList.remove("capybara-player--catch")},500)),!1}return i.y>this.container.clientHeight?(r.incrementMissed(),this.spawner.removeVegetable(i.id),!1):!0}),this.particles.update(),this.hud.updateScore(r.score),this.hud.updateLevel(r.level),this.hud.updateLives(3-r.missedVegetables),this.hud.updateProgress(r.capybaraFillPercentage),this.player.updateFill(r.capybaraFillPercentage)}render(){this.particles.render()}checkCollision(e,t){return t.x<e.x+e.width&&t.x+30>e.x&&t.y<e.y+e.height&&t.y+30>e.y}restart(){r.resetGame(),this.vegetables.forEach(e=>{this.spawner.removeVegetable(e.id)}),this.vegetables=[],this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy()}}class F{constructor(){s(this,"gameEngine",null);s(this,"container");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),i=()=>{e.remove(),this.startGame()};t.addEventListener("click",i),t.addEventListener("touchend",l=>{l.preventDefault(),i()}),e.addEventListener("touchmove",l=>{l.preventDefault()}),e.addEventListener("click",l=>{l.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new C(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new F});window.addEventListener("resize",()=>{const n=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");n&&e&&(n.width=e.clientWidth,n.height=e.clientHeight)});
