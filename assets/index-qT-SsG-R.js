var T=Object.defineProperty,_=Object.defineProperties;var k=Object.getOwnPropertyDescriptors;var E=Object.getOwnPropertySymbols;var M=Object.prototype.hasOwnProperty,D=Object.prototype.propertyIsEnumerable;var b=(n,e,t)=>e in n?T(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,w=(n,e)=>{for(var t in e||(e={}))M.call(e,t)&&b(n,t,e[t]);if(E)for(var t of E(e))D.call(e,t)&&b(n,t,e[t]);return n},C=(n,e)=>_(n,k(e));var s=(n,e,t)=>b(n,typeof e!="symbol"?e+"":e,t);var y=(n,e,t)=>new Promise((i,a)=>{var l=d=>{try{o(t.next(d))}catch(m){a(m)}},r=d=>{try{o(t.throw(d))}catch(m){a(m)}},o=d=>d.done?i(d.value):Promise.resolve(d.value).then(l,r);o((t=t.apply(n,e)).next())});(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(a){if(a.ep)return;a.ep=!0;const l=t(a);fetch(a.href,l)}})();const P="modulepreload",N=function(n){return"/capibara/"+n},S={},O=function(e,t,i){let a=Promise.resolve();if(t&&t.length>0){let m=function(h){return Promise.all(h.map(p=>Promise.resolve(p).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};var r=m;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));a=m(t.map(h=>{if(h=N(h),h in S)return;S[h]=!0;const p=h.endsWith(".css"),g=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${g}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":P,p||(u.as="script"),u.crossOrigin="",u.href=h,d&&u.setAttribute("nonce",d),document.head.appendChild(u),p)return new Promise((F,A)=>{u.addEventListener("load",F),u.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${h}`)))})}))}function l(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return a.then(o=>{for(const d of o||[])d.status==="rejected"&&l(d.reason);return e().catch(l)})},V=n=>{let e;const t=new Set,i=(m,h)=>{const p=typeof m=="function"?m(e):m;if(!Object.is(p,e)){const g=e;e=(h!=null?h:typeof p!="object"||p===null)?p:Object.assign({},e,p),t.forEach(u=>u(e,g))}},a=()=>e,o={setState:i,getState:a,getInitialState:()=>d,subscribe:m=>(t.add(m),()=>t.delete(m))},d=e=n(i,a,o);return o},H=(n=>V);class c{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const i=this.getCapybaraWidth(),a=this.getCapybaraHeight(),l=this.getCapybaraBottom();return{x:e,y:t-l-a,width:i,height:a}}static calculateFillPercentage(e){return Math.min(100,e/this.LEVEL_UP_THRESHOLD*100)}static getPointsForLevelUp(){return this.LEVEL_UP_THRESHOLD}}s(c,"MOBILE_BREAKPOINT",768),s(c,"CAPYBARA_WIDTH_DESKTOP",100),s(c,"CAPYBARA_HEIGHT_DESKTOP",75),s(c,"CAPYBARA_WIDTH_MOBILE",100),s(c,"CAPYBARA_HEIGHT_MOBILE",75),s(c,"CAPYBARA_BOTTOM_DESKTOP",20),s(c,"CAPYBARA_BOTTOM_MOBILE",10),s(c,"VEGETABLE_SIZE_DESKTOP",50),s(c,"VEGETABLE_SIZE_MOBILE",40),s(c,"PLAYER_SPEED",8),s(c,"SPAWN_RATE_BASE",2e3),s(c,"SPAWN_RATE_DECREASE",100),s(c,"MIN_SPAWN_RATE",800),s(c,"LEVEL_UP_THRESHOLD",50),s(c,"AUDIO_ENABLED_DEFAULT",!0),s(c,"MASTER_VOLUME",.6),s(c,"ANIMATION_DURATION_FAST",300),s(c,"ANIMATION_DURATION_NORMAL",600),s(c,"ANIMATION_DURATION_SLOW",1e3),s(c,"REDUCE_ANIMATIONS",!1);const L=H()(n=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100,incrementLevel:()=>n(e=>({level:e.level+1,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>n(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>n(t=>{const i=t.score+e,a=t.capybaraFillPercentage+e,l=a>=c.LEVEL_UP_THRESHOLD;return{score:i,capybaraFillPercentage:l?c.LEVEL_UP_THRESHOLD:a,gameStatus:l?"won":t.gameStatus}}),resetForNextLevel:()=>n(()=>({capybaraFillPercentage:0,missedVegetables:0,gameStatus:"playing"})),resetGame:()=>n(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100})),pauseGame:()=>n(()=>({gameStatus:"paused"})),resumeGame:()=>n(()=>({gameStatus:"playing"}))}));class I{constructor(){s(this,"level",1);s(this,"score",0);s(this,"missedVegetables",0);s(this,"capybaraFillPercentage",0);s(this,"gameStatus","playing");s(this,"fallSpeed",2);s(this,"ceilingHeight",100);s(this,"vegetables",[]);s(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const x=new I;class R{constructor(e){s(this,"element");s(this,"fillElement");s(this,"svgElement");s(this,"x",0);s(this,"lastX",0);s(this,"gameContainer");s(this,"speed",8);s(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-c.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
    ...
    `,this.element.addEventListener("click",()=>y(this,null,function*(){yield this.audioManager.init(),this.audioManager.play("click");const e=this.audioManager.toggle();this.element.innerHTML=e?"🔊":"🔇",this.element.style.opacity=e?"1":"0.6"})),this.element.addEventListener("mouseenter",()=>{this.element.style.transform="scale(1.1)"}),this.element.addEventListener("mouseleave",()=>{this.element.style.transform="scale(1)"})}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class Y{constructor(e){s(this,"container");s(this,"player");s(this,"spawner");s(this,"particles");s(this,"hud");s(this,"gameOverScreen");s(this,"levelTransition");s(this,"pauseOverlay");s(this,"helpModal");s(this,"audioToggle");s(this,"audioManager",f.getInstance());s(this,"animationId",0);s(this,"lastTime",0);s(this,"vegetables",[]);s(this,"gameStore",L);s(this,"levelTransitionActive",!1);this.container=e,this.init()}init(){this.player=new R(this.container),this.spawner=new Q(this.container),this.particles=new z(this.container),this.hud=new W(this.container),this.gameOverScreen=new q(this.container,()=>this.restart()),this.levelTransition=new G(this.container),this.pauseOverlay=new $(this.container,()=>this.helpModal.show()),this.helpModal=new B,this.audioToggle=new K(document.body),L.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"&&!this.levelTransitionActive?(this.levelTransitionActive=!0,this.audioManager.play("levelup"),this.clearAllVegetables(),this.levelTransition.show(e.level+1),setTimeout(()=>{this.gameStore.getState().incrementLevel(),this.gameStore.getState().resetForNextLevel(),this.levelTransitionActive=!1},2e3)):e.gameStatus==="lost"&&(this.audioManager.play("gameover"),this.gameOverScreen.show(!1,e.score,e.level))}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const i=this.gameStore.getState();(i.gameStatus==="lost"||i.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const i=this.gameStore.getState();i.gameStatus==="playing"&&!this.levelTransitionActive?(this.update(t),this.render()):i.gameStatus,this.animationId=requestAnimationFrame(a=>this.gameLoop(a))}update(e){const t=this.gameStore.getState();if(t.gameStatus!=="playing"||this.levelTransitionActive)return;const i=this.spawner.update(e,t.level);this.vegetables.push(...i),this.vegetables=this.vegetables.filter(r=>{const o=r.y+r.speed;if(this.gameStore.getState().gameStatus!=="playing"||this.levelTransitionActive)return this.spawner.removeVegetable(r.id),!1;const m=this.player.getBounds();if(this.checkCollision(m,C(w({},r),{y:o}))){this.audioManager.play("catch"),t.updateScore(r.points),this.particles.createCatchEffect(r.x,o),this.spawner.removeVegetable(r.id);const h=this.container.querySelector(".capybara-player");return h&&(h.classList.add("capybara-player--catch"),setTimeout(()=>{h.classList.remove("capybara-player--catch")},600)),this.createScorePopup(r.x,o,r.points),!1}return o>this.container.clientHeight?(this.audioManager.play("miss"),t.incrementMissed(),this.spawner.removeVegetable(r.id),!1):(r.y=o,this.spawner.updateVegetablePosition(r),!0)}),this.particles.update();const a=this.gameStore.getState();this.hud.updateScore(a.score),this.hud.updateLevel(a.level),this.hud.updateLives(3-a.missedVegetables);const l=c.calculateFillPercentage(a.capybaraFillPercentage);this.hud.updateProgress(l),this.player.updateFill(l)}render(){this.particles.render()}checkCollision(e,t){const i=c.getVegetableSize(),a=.3,l=Math.max(0,Math.min(e.x+e.width,t.x+i)-Math.max(e.x,t.x)),r=Math.max(0,Math.min(e.y+e.height,t.y+i)-Math.max(e.y,t.y)),d=Math.min(e.width*e.height,i*i)*a;return l*r>=d}clearAllVegetables(){this.vegetables=[],this.spawner.reset()}restart(){this.clearAllVegetables(),this.gameStore.getState().resetGame(),this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}createScorePopup(e,t,i){const a=document.createElement("div");a.className="score-popup",a.textContent=`+${i}`,a.style.cssText=`
      ...
      pointer-events: none;
      z-index: 1000;
    `,this.container.appendChild(a),setTimeout(()=>{a.parentNode&&a.parentNode.removeChild(a)},1e3)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy(),this.audioToggle.destroy()}}class X{constructor(){s(this,"gameEngine",null);s(this,"container");s(this,"helpModal");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.helpModal=new B,this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
