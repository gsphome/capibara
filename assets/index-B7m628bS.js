var c=Object.defineProperty;var h=(n,e,t)=>e in n?c(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var l=(n,e,t)=>h(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();class d{constructor(){l(this,"level",1);l(this,"score",0);l(this,"missedVegetables",0);l(this,"capybaraFillPercentage",0);l(this,"gameStatus","playing");l(this,"fallSpeed",2);l(this,"ceilingHeight",100);l(this,"vegetables",[]);l(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won"),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const r=new d;class m{constructor(e){l(this,"element");l(this,"fillElement");l(this,"svgElement");l(this,"x",0);l(this,"lastX",0);l(this,"gameContainer");l(this,"speed",8);l(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-50,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
    ...
    `,e.appendChild(this.fillElement),e.appendChild(this.svgElement),this.element.appendChild(e),this.updatePosition()}setupControls(){document.addEventListener("keydown",t=>{if(r.gameStatus==="playing")switch(t.key){case"ArrowLeft":case"a":case"A":this.moveLeft();break;case"ArrowRight":case"d":case"D":this.moveRight();break}}),document.addEventListener("mousemove",t=>{if(r.gameStatus!=="playing")return;const i=this.gameContainer.getBoundingClientRect(),s=t.clientX-i.left;this.x=Math.max(0,Math.min(this.gameContainer.clientWidth-100,s-50)),this.updatePosition()});let e=!1;document.addEventListener("touchstart",t=>{const i=t.target;i.closest(".pause-overlay")||i.closest(".game-over")||i.closest(".level-transition")||(e=!0,t.preventDefault())},{passive:!1}),document.addEventListener("touchmove",t=>{if(!e||r.gameStatus!=="playing")return;const i=t.target;if(i.closest(".pause-overlay")||i.closest(".game-over")||i.closest(".level-transition"))return;const s=t.touches[0],a=this.gameContainer.getBoundingClientRect(),o=s.clientX-a.left;this.x=Math.max(0,Math.min(this.gameContainer.clientWidth-100,o-50)),this.updatePosition(),t.preventDefault()},{passive:!1}),document.addEventListener("touchend",()=>{e=!1})}moveLeft(){this.x=Math.max(0,this.x-this.speed),this.updatePosition()}moveRight(){this.x=Math.min(this.gameContainer.clientWidth-100,this.x+this.speed),this.updatePosition()}updatePosition(){this.element.style.left=`${this.x}px`;const e=this.x>this.lastX?"right":this.x<this.lastX?"left":this.direction;if(e!==this.direction){this.direction=e;const t=this.svgElement.querySelector("use");t&&t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",`#capybara-${this.direction}`),this.element.classList.add("capybara-player--running"),setTimeout(()=>{this.element.classList.remove("capybara-player--running")},300)}this.lastX=this.x}updateFill(e){this.fillElement.style.height=`${e}%`,e>=80?this.fillElement.style.background="linear-gradient(45deg, #FFD700, #FFA500)":e>=50&&(this.fillElement.style.background="linear-gradient(45deg, #ADFF2F, #32CD32)")}getBounds(){return{x:this.x,y:this.gameContainer.clientHeight-145,width:100,height:75}}getX(){return this.x}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class p{constructor(e){l(this,"container");l(this,"spawnTimer",0);l(this,"vegetableTypes",["carrot","broccoli","lettuce","tomato","pepper"]);l(this,"activeVegetables",new Map);this.container=e}update(e,t){this.spawnTimer+=e;const i=Math.max(800,2e3-t*100),s=[];if(this.spawnTimer>=i){const a=this.spawnVegetable(t);s.push(a),this.spawnTimer=0}return s}spawnVegetable(e){const t=this.vegetableTypes[Math.floor(Math.random()*this.vegetableTypes.length)],i=Math.random()*(this.container.clientWidth-30),s={id:Date.now().toString()+Math.random(),type:t,x:i,y:-30,speed:2+e*.3,points:this.getVegetablePoints(t)};return this.createVegetableElement(s),s}createVegetableElement(e){const t=document.createElement("div");t.className=`vegetable vegetable--${e.type}`,t.style.left=`${e.x}px`,t.style.top=`${e.y}px`,t.id=e.id;const i=document.createElementNS("http://www.w3.org/2000/svg","svg");i.setAttribute("viewBox","0 0 30 30"),i.setAttribute("width","30"),i.setAttribute("height","30");const s=document.createElementNS("http://www.w3.org/2000/svg","use");s.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",`#${e.type}`),i.appendChild(s),t.appendChild(i),this.container.appendChild(t),this.activeVegetables.set(e.id,t)}updateVegetablePosition(e){const t=this.activeVegetables.get(e.id);t&&(t.style.top=`${e.y}px`)}removeVegetable(e){const t=this.activeVegetables.get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),this.activeVegetables.delete(e))}getVegetablePoints(e){return{carrot:5,broccoli:8,lettuce:3,tomato:6,pepper:10}[e]||5}}class y{constructor(e){l(this,"particles",[]);l(this,"canvas");l(this,"ctx");this.canvas=document.createElement("canvas"),this.canvas.className="particle-canvas",this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight,this.canvas.style.position="absolute",this.canvas.style.top="0",this.canvas.style.left="0",this.canvas.style.pointerEvents="none",this.canvas.style.zIndex="15",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),window.addEventListener("resize",()=>{this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight})}createCatchEffect(e,t){for(let i=0;i<8;i++)this.particles.push({x:e+15,y:t+15,vx:(Math.random()-.5)*6,vy:(Math.random()-.5)*6,life:30,maxLife:30,color:`hsl(${Math.random()*60+60}, 70%, 60%)`})}update(){this.particles=this.particles.filter(e=>(e.x+=e.vx,e.y+=e.vy,e.vy+=.1,e.life--,e.life>0))}render(){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.particles.forEach(e=>{const t=e.life/e.maxLife;this.ctx.globalAlpha=t,this.ctx.fillStyle=e.color,this.ctx.fillRect(e.x,e.y,4,4)}),this.ctx.globalAlpha=1}destroy(){this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas)}}class u{constructor(e){l(this,"element");l(this,"scoreElement");l(this,"levelElement");l(this,"missedElement");l(this,"progressBar");l(this,"progressFill");const t=document.querySelector(".game-hud");t&&t.remove(),this.createElement();let i=document.querySelector(".game-wrapper"),s=document.querySelector(".game-sidebar");i?s&&s.appendChild(this.element):(i=document.createElement("div"),i.className="game-wrapper",s=document.createElement("div"),s.className="game-sidebar",s.appendChild(this.element),i.appendChild(s),i.appendChild(e),document.body.appendChild(i))}createElement(){this.element=document.createElement("div"),this.element.className="game-hud",this.scoreElement=document.createElement("div"),this.scoreElement.className="game-hud__score",this.scoreElement.textContent="Score: 0",this.levelElement=document.createElement("div"),this.levelElement.className="game-hud__level",this.levelElement.textContent="Level: 1",this.missedElement=document.createElement("div"),this.missedElement.className="game-hud__missed",this.missedElement.textContent="Missed: 0/3",this.element.appendChild(this.scoreElement),this.element.appendChild(this.levelElement),this.element.appendChild(this.missedElement);const e=document.createElement("div");e.className="progress-bar",this.progressFill=document.createElement("div"),this.progressFill.className="progress-bar__fill",this.progressFill.style.width="0%",e.appendChild(this.progressFill),this.element.appendChild(e),this.progressBar=e}updateScore(e){this.scoreElement.textContent=`Score: ${e}`}updateLevel(e){this.levelElement.textContent=`Level: ${e}`}updateMissed(e){this.missedElement.textContent=`Missed: ${e}/3`,e>=2?this.missedElement.style.color="#ff4444":this.missedElement.style.color="white"}updateProgress(e){this.progressFill.style.width=`${e}%`,e>=100&&(this.progressFill.style.background="linear-gradient(90deg, #FFD700, #FFA500)")}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.progressBar.parentNode&&this.progressBar.parentNode.removeChild(this.progressBar)}}class g{constructor(e,t){l(this,"element");l(this,"onRestart");this.onRestart=t,this.createElement(),e.appendChild(this.element),this.hide()}createElement(){this.element=document.createElement("div"),this.element.className="game-over";const e=document.createElement("h1");e.className="game-over__title";const t=document.createElement("div");t.className="game-over__score";const i=document.createElement("button");i.className="game-over__button",i.textContent="Play Again",i.addEventListener("click",this.onRestart),this.element.appendChild(e),this.element.appendChild(t),this.element.appendChild(i)}show(e,t,i){const s=this.element.querySelector(".game-over__title"),a=this.element.querySelector(".game-over__score");e?(s.textContent="🎉 You Win! 🎉",s.style.color="#FFD700",a.textContent=`Capybara is full! Final Score: ${t} (Level ${i})`):(s.textContent="💔 Game Over 💔",s.style.color="#FF4444",a.textContent=`Too many vegetables missed! Final Score: ${t} (Level ${i})`),this.element.style.display="flex"}hide(){this.element.style.display="none"}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class f{constructor(e){l(this,"element");l(this,"container");this.container=e}show(e){this.createElement(e),this.container.appendChild(this.element),setTimeout(()=>{this.element.classList.add("level-transition--show")},50),setTimeout(()=>{this.hide()},2e3)}createElement(e){this.element=document.createElement("div"),this.element.className="level-transition",this.element.innerHTML=`
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),i=()=>{this.hide(),e()};t.addEventListener("click",i),t.addEventListener("touchend",a=>{a.preventDefault(),i()});const s=a=>{a.code==="Space"&&(a.preventDefault(),i(),document.removeEventListener("keydown",s))};document.addEventListener("keydown",s)}}class x{constructor(e){l(this,"container");l(this,"player");l(this,"spawner");l(this,"particles");l(this,"hud");l(this,"gameOverScreen");l(this,"levelTransition");l(this,"pauseOverlay");l(this,"animationId",0);l(this,"lastTime",0);l(this,"vegetables",[]);this.container=e,this.init()}init(){this.player=new m(this.container),this.spawner=new p(this.container),this.particles=new y(this.container),this.hud=new u(this.container),this.gameOverScreen=new g(this.container,()=>this.restart()),this.levelTransition=new f(this.container),this.pauseOverlay=new v(this.container),r.addListener(()=>this.handleGameStateChange()),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(){r.gameStatus==="paused"?this.pauseOverlay.show(()=>r.resumeGame()):r.gameStatus==="playing"?this.pauseOverlay.hide():r.gameStatus==="won"?(this.levelTransition.show(r.level+1),setTimeout(()=>{r.resetForNextLevel(),r.gameStatus="playing"},2e3)):r.gameStatus==="lost"&&this.gameOverScreen.show(!1,r.score,r.level)}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault(),r.gameStatus==="playing"?r.pauseGame():r.gameStatus==="paused"&&r.resumeGame();break;case"r":case"R":(r.gameStatus==="lost"||r.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e,r.gameStatus==="playing"?(this.update(t),this.render()):r.gameStatus,this.animationId=requestAnimationFrame(i=>this.gameLoop(i))}update(e){const t=this.spawner.update(e,r.level);this.vegetables.push(...t),this.vegetables=this.vegetables.filter(s=>{s.y+=s.speed,this.spawner.updateVegetablePosition(s);const a=this.player.getBounds();if(this.checkCollision(a,s)){r.updateScore(s.points),this.particles.createCatchEffect(s.x,s.y),this.spawner.removeVegetable(s.id);const o=this.container.querySelector(".capybara-player");return o&&(o.classList.add("capybara-player--catch"),setTimeout(()=>{o.classList.remove("capybara-player--catch")},500)),!1}return s.y>this.container.clientHeight?(r.incrementMissed(),this.spawner.removeVegetable(s.id),!1):!0}),this.particles.update(),this.hud.updateScore(r.score),this.hud.updateLevel(r.level),this.hud.updateMissed(r.missedVegetables),this.hud.updateProgress(r.capybaraFillPercentage),this.player.updateFill(r.capybaraFillPercentage);const i=r.level*100;r.score>=i&&r.capybaraFillPercentage<100&&r.incrementLevel()}render(){this.particles.render()}checkCollision(e,t){return t.x<e.x+e.width&&t.x+30>e.x&&t.y<e.y+e.height&&t.y+30>e.y}restart(){r.resetGame(),this.vegetables.forEach(e=>{this.spawner.removeVegetable(e.id)}),this.vegetables=[],this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateMissed(0),this.hud.updateProgress(0),this.player.updateFill(0)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy()}}class w{constructor(){l(this,"gameEngine",null);l(this,"container");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),i=()=>{e.remove(),this.startGame()};t.addEventListener("click",i),t.addEventListener("touchend",s=>{s.preventDefault(),i()}),e.addEventListener("touchmove",s=>{s.preventDefault()}),e.addEventListener("click",s=>{s.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new x(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new w});window.addEventListener("resize",()=>{const n=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");n&&e&&(n.width=e.clientWidth,n.height=e.clientHeight)});
