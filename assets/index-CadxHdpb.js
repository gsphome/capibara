var E=Object.defineProperty;var w=(r,e,t)=>e in r?E(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var i=(r,e,t)=>w(r,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=t(a);fetch(a.href,l)}})();const C=r=>{let e;const t=new Set,s=(h,y)=>{const p=typeof h=="function"?h(e):h;if(!Object.is(p,e)){const b=e;e=(y!=null?y:typeof p!="object"||p===null)?p:Object.assign({},e,p),t.forEach(x=>x(e,b))}},a=()=>e,c={setState:s,getState:a,getInitialState:()=>u,subscribe:h=>(t.add(h),()=>t.delete(h))},u=e=r(s,a,c);return c},S=(r=>C);class n{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const s=this.getCapybaraWidth(),a=this.getCapybaraHeight(),l=this.getCapybaraBottom();return{x:e,y:t-l-a,width:s,height:a}}}i(n,"MOBILE_BREAKPOINT",768),i(n,"CAPYBARA_WIDTH_DESKTOP",100),i(n,"CAPYBARA_HEIGHT_DESKTOP",75),i(n,"CAPYBARA_WIDTH_MOBILE",100),i(n,"CAPYBARA_HEIGHT_MOBILE",75),i(n,"CAPYBARA_BOTTOM_DESKTOP",20),i(n,"CAPYBARA_BOTTOM_MOBILE",10),i(n,"VEGETABLE_SIZE_DESKTOP",50),i(n,"VEGETABLE_SIZE_MOBILE",40),i(n,"PLAYER_SPEED",8),i(n,"SPAWN_RATE_BASE",2e3),i(n,"SPAWN_RATE_DECREASE",100),i(n,"MIN_SPAWN_RATE",800),i(n,"LEVEL_UP_THRESHOLD",50),i(n,"AUDIO_ENABLED_DEFAULT",!0),i(n,"MASTER_VOLUME",.6),i(n,"ANIMATION_DURATION_FAST",300),i(n,"ANIMATION_DURATION_NORMAL",600),i(n,"ANIMATION_DURATION_SLOW",1e3),i(n,"REDUCE_ANIMATIONS",!1);const v=S()(r=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[],addVegetable:e=>r(t=>({vegetables:[...t.vegetables,e]})),removeVegetable:e=>r(t=>({vegetables:t.vegetables.filter(s=>s.id!==e)})),incrementLevel:()=>r(e=>({level:e.level+1,fallSpeed:e.fallSpeed*1.15,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>r(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>r(t=>{const s=Math.min(100,t.capybaraFillPercentage+e);return{score:t.score+e,capybaraFillPercentage:s,gameStatus:s>=n.LEVEL_UP_THRESHOLD?"won":t.gameStatus}}),resetForNextLevel:()=>r(()=>({capybaraFillPercentage:0,missedVegetables:0,vegetables:[],gameStatus:"playing"})),resetGame:()=>r(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[]})),pauseGame:()=>r(()=>({gameStatus:"paused"})),resumeGame:()=>r(()=>({gameStatus:"playing"}))}));class L{constructor(){i(this,"level",1);i(this,"score",0);i(this,"missedVegetables",0);i(this,"capybaraFillPercentage",0);i(this,"gameStatus","playing");i(this,"fallSpeed",2);i(this,"ceilingHeight",100);i(this,"vegetables",[]);i(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const g=new L;class B{constructor(e){i(this,"element");i(this,"fillElement");i(this,"svgElement");i(this,"x",0);i(this,"lastX",0);i(this,"gameContainer");i(this,"speed",8);i(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-n.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
    ...
    `;const e=this.element.querySelector(".help-modal__close"),t=this.element.querySelector(".help-modal__backdrop"),s=()=>this.hide();e.addEventListener("click",s),t.addEventListener("click",s);const a=l=>{l.key==="Escape"&&(s(),document.removeEventListener("keydown",a))};document.addEventListener("keydown",a)}}const d=class d{constructor(){i(this,"enabled",!0)}static getInstance(){return d.instance||(d.instance=new d),d.instance}play(e){if(!this.enabled)return;const t=new(window.AudioContext||window.webkitAudioContext),s=t.createOscillator(),a=t.createGain();s.connect(a),a.connect(t.destination);const o={catch:{freq:800,duration:.1},miss:{freq:200,duration:.2},levelup:{freq:1e3,duration:.3},gameover:{freq:150,duration:.5},click:{freq:600,duration:.05}}[e];o&&(s.frequency.value=o.freq,s.type="sine",a.gain.setValueAtTime(0,t.currentTime),a.gain.linearRampToValueAtTime(.3,t.currentTime+.01),a.gain.exponentialRampToValueAtTime(.01,t.currentTime+o.duration),s.start(),s.stop(t.currentTime+o.duration))}toggle(){return this.enabled=!this.enabled,this.enabled}isEnabled(){return this.enabled}};i(d,"instance");let m=d;class D{constructor(e){i(this,"element");i(this,"audioManager",m.getInstance());this.createElement(),e.appendChild(this.element)}createElement(){this.element=document.createElement("button"),this.element.className="audio-toggle",this.element.innerHTML="🔊",this.element.style.cssText=`
      position: fixed;
      top: 10px;
      right: 10px;
