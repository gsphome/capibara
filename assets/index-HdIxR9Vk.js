var F=Object.defineProperty,B=Object.defineProperties;var M=Object.getOwnPropertyDescriptors;var w=Object.getOwnPropertySymbols;var k=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var b=(r,e,t)=>e in r?F(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,E=(r,e)=>{for(var t in e||(e={}))k.call(e,t)&&b(r,t,e[t]);if(w)for(var t of w(e))P.call(e,t)&&b(r,t,e[t]);return r},C=(r,e)=>B(r,M(e));var a=(r,e,t)=>b(r,typeof e!="symbol"?e+"":e,t);var y=(r,e,t)=>new Promise((i,s)=>{var l=d=>{try{o(t.next(d))}catch(u){s(u)}},n=d=>{try{o(t.throw(d))}catch(u){s(u)}},o=d=>d.done?i(d.value):Promise.resolve(d.value).then(l,n);o((t=t.apply(r,e)).next())});(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function i(s){if(s.ep)return;s.ep=!0;const l=t(s);fetch(s.href,l)}})();const D="modulepreload",O=function(r){return"/capibara/"+r},S={},N=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){let u=function(h){return Promise.all(h.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};var n=u;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=u(t.map(h=>{if(h=O(h),h in S)return;S[h]=!0;const m=h.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${p}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":D,m||(g.as="script"),g.crossOrigin="",g.href=h,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((T,_)=>{g.addEventListener("load",T),g.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${h}`)))})}))}function l(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return s.then(o=>{for(const d of o||[])d.status==="rejected"&&l(d.reason);return e().catch(l)})},H=r=>{let e;const t=new Set,i=(u,h)=>{const m=typeof u=="function"?u(e):u;if(!Object.is(m,e)){const p=e;e=(h!=null?h:typeof m!="object"||m===null)?m:Object.assign({},e,m),t.forEach(g=>g(e,p))}},s=()=>e,o={setState:i,getState:s,getInitialState:()=>d,subscribe:u=>(t.add(u),()=>t.delete(u))},d=e=r(i,s,o);return o},V=(r=>H);class c{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const i=this.getCapybaraWidth(),s=this.getCapybaraHeight(),l=this.getCapybaraBottom();return{x:e,y:t-l-s,width:i,height:s}}static calculateFillPercentage(e){return Math.min(100,e/this.LEVEL_UP_THRESHOLD*100)}static getPointsForLevelUp(){return this.LEVEL_UP_THRESHOLD}}a(c,"MOBILE_BREAKPOINT",768),a(c,"CAPYBARA_WIDTH_DESKTOP",100),a(c,"CAPYBARA_HEIGHT_DESKTOP",75),a(c,"CAPYBARA_WIDTH_MOBILE",100),a(c,"CAPYBARA_HEIGHT_MOBILE",75),a(c,"CAPYBARA_BOTTOM_DESKTOP",20),a(c,"CAPYBARA_BOTTOM_MOBILE",10),a(c,"VEGETABLE_SIZE_DESKTOP",50),a(c,"VEGETABLE_SIZE_MOBILE",40),a(c,"PLAYER_SPEED",8),a(c,"SPAWN_RATE_BASE",2e3),a(c,"SPAWN_RATE_DECREASE",100),a(c,"MIN_SPAWN_RATE",800),a(c,"LEVEL_UP_THRESHOLD",50),a(c,"AUDIO_ENABLED_DEFAULT",!0),a(c,"MASTER_VOLUME",.6),a(c,"ANIMATION_DURATION_FAST",300),a(c,"ANIMATION_DURATION_NORMAL",600),a(c,"ANIMATION_DURATION_SLOW",1e3),a(c,"REDUCE_ANIMATIONS",!1);const L=V()(r=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100,incrementLevel:()=>r(e=>({level:e.level+1,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>r(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>r(t=>{const i=t.score+e,s=t.capybaraFillPercentage+e,l=s>=c.LEVEL_UP_THRESHOLD;return{score:i,capybaraFillPercentage:l?c.LEVEL_UP_THRESHOLD:s,gameStatus:l?"won":t.gameStatus}}),resetForNextLevel:()=>r(()=>({capybaraFillPercentage:0,missedVegetables:0,gameStatus:"playing"})),resetGame:()=>r(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100})),pauseGame:()=>r(()=>({gameStatus:"paused"})),resumeGame:()=>r(()=>({gameStatus:"playing"}))}));class I{constructor(){a(this,"level",1);a(this,"score",0);a(this,"missedVegetables",0);a(this,"capybaraFillPercentage",0);a(this,"gameStatus","playing");a(this,"fallSpeed",2);a(this,"ceilingHeight",100);a(this,"vegetables",[]);a(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const x=new I;class R{constructor(e){a(this,"element");a(this,"fillElement");a(this,"svgElement");a(this,"x",0);a(this,"lastX",0);a(this,"gameContainer");a(this,"speed",8);a(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-c.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),i=this.element.querySelector("#pauseHelpBtn"),s=()=>{this.hide(),e()};t.addEventListener("click",s),t.addEventListener("touchend",n=>{n.preventDefault(),s()}),i&&this.onShowHelp&&i.addEventListener("click",this.onShowHelp);const l=n=>{n.code==="Space"&&(n.preventDefault(),s(),document.removeEventListener("keydown",l))};document.addEventListener("keydown",l)}}class A{constructor(){a(this,"element")}show(){this.createElement(),document.body.appendChild(this.element),setTimeout(()=>{this.element.classList.add("help-modal--show")},50)}hide(){this.element&&(this.element.classList.remove("help-modal--show"),setTimeout(()=>{this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)},300))}createElement(){this.element=document.createElement("div"),this.element.className="help-modal",this.element.innerHTML=`
    ...
    `;const e=this.element.querySelector(".help-modal__close"),t=this.element.querySelector(".help-modal__backdrop"),i=()=>this.hide();e.addEventListener("click",i),t.addEventListener("click",i);const s=l=>{l.key==="Escape"&&(i(),document.removeEventListener("keydown",s))};document.addEventListener("keydown",s)}}const v=class v{constructor(){a(this,"enabled",!0);a(this,"audioContext",null);a(this,"initialized",!1);a(this,"useHTML5Audio",!1);a(this,"audioElements",new Map);this.detectAudioSupport(),this.setupMobileAudioInit()}detectAudioSupport(){const e=/iPad|iPhone|iPod/.test(navigator.userAgent),t=/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);this.useHTML5Audio=e&&t,console.log("Audio method:",this.useHTML5Audio?"HTML5 Audio":"Web Audio API"),this.useHTML5Audio&&this.createHTML5Sounds()}createHTML5Sounds(){["catch","miss","levelup","gameover","click"].forEach(t=>{const i=new Audio;i.preload="auto";const s=this.getSoundFrequency(t),l=this.getSoundDuration(t);i.src=this.createBeepDataURL(s,l),i.volume=.3,this.audioElements.set(t,i)})}getSoundFrequency(e){return{catch:800,miss:200,levelup:1e3,gameover:150,click:600}[e]||440}getSoundDuration(e){return{catch:.1,miss:.2,levelup:.3,gameover:.5,click:.05}[e]||.1}createBeepDataURL(e,t){const s=Math.floor(8e3*t),l=new ArrayBuffer(44+s*2),n=new DataView(l),o=(u,h)=>{for(let m=0;m<h.length;m++)n.setUint8(u+m,h.charCodeAt(m))};o(0,"RIFF"),n.setUint32(4,36+s*2,!0),o(8,"WAVE"),o(12,"fmt "),n.setUint32(16,16,!0),n.setUint16(20,1,!0),n.setUint16(22,1,!0),n.setUint32(24,8e3,!0),n.setUint32(28,8e3*2,!0),n.setUint16(32,2,!0),n.setUint16(34,16,!0),o(36,"data"),n.setUint32(40,s*2,!0);for(let u=0;u<s;u++){const h=Math.sin(2*Math.PI*e*u/8e3)*.3*32767;n.setInt16(44+u*2,h,!0)}const d=new Blob([l],{type:"audio/wav"});return URL.createObjectURL(d)}static getInstance(){return v.instance||(v.instance=new v),v.instance}setupMobileAudioInit(){const e=/iPad|iPhone|iPod/.test(navigator.userAgent),t=()=>y(this,null,function*(){this.initialized||(console.log("Initializing audio for mobile, iOS detected:",e),yield this.init(),this.initialized=!0,e&&setTimeout(()=>y(this,null,function*(){try{yield this.playUnlockSound()}catch(i){console.warn("Additional iOS unlock failed:",i)}}),200),document.removeEventListener("touchstart",t),document.removeEventListener("click",t))});document.addEventListener("touchstart",t,{once:!0}),document.addEventListener("click",t,{once:!0})}play(e){return y(this,null,function*(){if(this.enabled)try{if(this.useHTML5Audio){const n=this.audioElements.get(e);if(n){n.currentTime=0;const o=n.play();o&&(yield o),console.log("HTML5 Audio played:",e)}return}if(this.initialized||(yield this.init(),this.initialized=!0),(!this.audioContext||this.audioContext.state==="closed")&&(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&(yield this.audioContext.resume()),this.audioContext.state!=="running"){console.warn("AudioContext not running, skipping sound");return}const t=this.audioContext.createOscillator(),i=this.audioContext.createGain();t.connect(i),i.connect(this.audioContext.destination);const l={catch:{freq:800,duration:.1},miss:{freq:200,duration:.2},levelup:{freq:1e3,duration:.3},gameover:{freq:150,duration:.5},click:{freq:600,duration:.05}}[e];if(!l)return;t.frequency.value=l.freq,t.type="sine",i.gain.setValueAtTime(0,this.audioContext.currentTime),i.gain.linearRampToValueAtTime(.3,this.audioContext.currentTime+.01),i.gain.exponentialRampToValueAtTime(.01,this.audioContext.currentTime+l.duration),t.start(),t.stop(this.audioContext.currentTime+l.duration)}catch(t){console.warn("Audio playback failed:",t)}})}toggle(){return this.enabled=!this.enabled,this.enabled}isEnabled(){return this.enabled}init(){return y(this,null,function*(){try{this.audioContext||(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&(yield this.audioContext.resume()),this.initialized||(yield this.playUnlockSound())}catch(e){console.warn("Audio initialization failed:",e)}})}playUnlockSound(){return y(this,null,function*(){try{if(!this.audioContext||this.audioContext.state!=="running")return;const e=this.audioContext.createOscillator(),t=this.audioContext.createGain();e.connect(t),t.connect(this.audioContext.destination),e.frequency.value=440,e.type="sine",t.gain.setValueAtTime(.001,this.audioContext.currentTime),t.gain.exponentialRampToValueAtTime(.001,this.audioContext.currentTime+.01),e.start(),e.stop(this.audioContext.currentTime+.01),console.log("iOS audio unlock sound played")}catch(e){console.warn("iOS audio unlock failed:",e)}})}};a(v,"instance");let f=v;const G=Object.freeze(Object.defineProperty({__proto__:null,AudioManager:f},Symbol.toStringTag,{value:"Module"}));class K{constructor(e){a(this,"container");a(this,"player");a(this,"spawner");a(this,"particles");a(this,"hud");a(this,"gameOverScreen");a(this,"levelTransition");a(this,"pauseOverlay");a(this,"helpModal");a(this,"audioManager",f.getInstance());a(this,"animationId",0);a(this,"lastTime",0);a(this,"vegetables",[]);a(this,"gameStore",L);a(this,"levelTransitionActive",!1);this.container=e,this.init()}init(){this.player=new R(this.container),this.spawner=new Q(this.container),this.particles=new $(this.container),this.hud=new U(this.container),this.gameOverScreen=new q(this.container,()=>this.restart()),this.levelTransition=new z(this.container),this.pauseOverlay=new W(this.container,()=>this.helpModal.show()),this.helpModal=new A,L.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"&&!this.levelTransitionActive?(this.levelTransitionActive=!0,this.audioManager.play("levelup"),this.clearAllVegetables(),this.levelTransition.show(e.level+1),setTimeout(()=>{this.gameStore.getState().incrementLevel(),this.gameStore.getState().resetForNextLevel(),this.levelTransitionActive=!1},2e3)):e.gameStatus==="lost"&&(this.audioManager.play("gameover"),this.gameOverScreen.show(!1,e.score,e.level))}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const i=this.gameStore.getState();(i.gameStatus==="lost"||i.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const i=this.gameStore.getState();i.gameStatus==="playing"&&!this.levelTransitionActive?(this.update(t),this.render()):i.gameStatus,this.animationId=requestAnimationFrame(s=>this.gameLoop(s))}update(e){const t=this.gameStore.getState();if(t.gameStatus!=="playing"||this.levelTransitionActive)return;const i=this.spawner.update(e,t.level);this.vegetables.push(...i),this.vegetables=this.vegetables.filter(n=>{const o=n.y+n.speed;if(this.gameStore.getState().gameStatus!=="playing"||this.levelTransitionActive)return this.spawner.removeVegetable(n.id),!1;const u=this.player.getBounds();if(this.checkCollision(u,C(E({},n),{y:o}))){this.audioManager.play("catch"),t.updateScore(n.points),this.particles.createCatchEffect(n.x,o),this.spawner.removeVegetable(n.id);const h=this.container.querySelector(".capybara-player");return h&&(h.classList.add("capybara-player--catch"),setTimeout(()=>{h.classList.remove("capybara-player--catch")},600)),this.createScorePopup(n.x,o,n.points),!1}return o>this.container.clientHeight?(this.audioManager.play("miss"),t.incrementMissed(),this.spawner.removeVegetable(n.id),!1):(n.y=o,this.spawner.updateVegetablePosition(n),!0)}),this.particles.update();const s=this.gameStore.getState();this.hud.updateScore(s.score),this.hud.updateLevel(s.level),this.hud.updateLives(3-s.missedVegetables);const l=c.calculateFillPercentage(s.capybaraFillPercentage);this.hud.updateProgress(l),this.player.updateFill(l)}render(){this.particles.render()}checkCollision(e,t){const i=c.getVegetableSize(),s=.3,l=Math.max(0,Math.min(e.x+e.width,t.x+i)-Math.max(e.x,t.x)),n=Math.max(0,Math.min(e.y+e.height,t.y+i)-Math.max(e.y,t.y)),d=Math.min(e.width*e.height,i*i)*s;return l*n>=d}clearAllVegetables(){this.vegetables=[],this.spawner.reset()}restart(){this.clearAllVegetables(),this.gameStore.getState().resetGame(),this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}createScorePopup(e,t,i){const s=document.createElement("div");s.className="score-popup",s.textContent=`+${i}`,s.style.cssText=`
      ...
      pointer-events: none;
      z-index: 1000;
    `,this.container.appendChild(s),setTimeout(()=>{s.parentNode&&s.parentNode.removeChild(s)},1e3)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy()}}class Y{constructor(e){a(this,"element");a(this,"audioManager",f.getInstance());const t=e.querySelector(".audio-toggle");t&&t.remove(),this.createElement(),e.appendChild(this.element)}createElement(){this.element=document.createElement("button"),this.element.className="audio-toggle",this.element.innerHTML="🔊",this.element.style.cssText=`
      position: fixed;
    ...
    `,this.element.addEventListener("click",e=>{e.stopPropagation(),e.preventDefault(),this.toggleAudio()}),this.element.addEventListener("touchend",e=>{e.stopPropagation(),e.preventDefault(),this.toggleAudio()}),this.element.addEventListener("mouseenter",()=>{this.element.style.transform="scale(1.1)"}),this.element.addEventListener("mouseleave",()=>{this.element.style.transform="scale(1)"})}toggleAudio(){return y(this,null,function*(){try{const e=this.audioManager.toggle();this.element.innerHTML=e?"🔊":"🔇",this.element.style.opacity=e?"1":"0.6",e&&(yield this.audioManager.init(),yield this.audioManager.play("click"))}catch(e){console.warn("Audio toggle failed:",e)}})}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class j{constructor(){a(this,"gameEngine",null);a(this,"container");a(this,"helpModal");a(this,"_audioToggle");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.helpModal=new A,this._audioToggle=new Y(document.body),this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,t=document.createElement("div");t.innerHTML=e,document.body.appendChild(t)}showInstructions(){const e=document.createElement("div"),t=window.innerWidth<=768;e.style.cssText=`
      ...
      overflow-y: auto;
    `;const i=t?"90vw":"350px",s=t?"1.5rem":"2rem",l=t?"1rem":"1.5rem";e.innerHTML=`
    ...
    `,this.container.appendChild(e);const n=e.querySelector("#startGame"),o=()=>{e.remove(),this.startGame()},d=h=>y(this,null,function*(){h&&h.preventDefault();try{const m=(yield N(()=>y(this,null,function*(){const{AudioManager:p}=yield Promise.resolve().then(()=>G);return{AudioManager:p}}),void 0)).AudioManager.getInstance();yield m.init(),yield new Promise(p=>setTimeout(p,100)),yield m.play("click"),console.log("Audio initialized successfully for iOS")}catch(m){console.warn("Audio initialization failed:",m)}o()});n.addEventListener("click",d),n.addEventListener("touchend",d);const u=e.querySelector("#helpButton");u&&u.addEventListener("click",()=>{this.helpModal.show()}),n.addEventListener("click",()=>{}),u.addEventListener("click",()=>{}),e.addEventListener("touchmove",h=>{h.preventDefault()}),e.addEventListener("click",h=>{h.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new K(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new j});window.addEventListener("resize",()=>{const r=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");r&&e&&(r.width=e.clientWidth,r.height=e.clientHeight)});
//# sourceMappingURL=index-HdIxR9Vk.js.map
