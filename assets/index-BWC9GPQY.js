var F=Object.defineProperty,_=Object.defineProperties;var k=Object.getOwnPropertyDescriptors;var w=Object.getOwnPropertySymbols;var M=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var b=(l,e,t)=>e in l?F(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t,E=(l,e)=>{for(var t in e||(e={}))M.call(e,t)&&b(l,t,e[t]);if(w)for(var t of w(e))P.call(e,t)&&b(l,t,e[t]);return l},C=(l,e)=>_(l,k(e));var s=(l,e,t)=>b(l,typeof e!="symbol"?e+"":e,t);var g=(l,e,t)=>new Promise((i,a)=>{var n=d=>{try{o(t.next(d))}catch(m){a(m)}},r=d=>{try{o(t.throw(d))}catch(m){a(m)}},o=d=>d.done?i(d.value):Promise.resolve(d.value).then(n,r);o((t=t.apply(l,e)).next())});(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=t(a);fetch(a.href,n)}})();const D="modulepreload",N=function(l){return"/capibara/"+l},S={},O=function(e,t,i){let a=Promise.resolve();if(t&&t.length>0){let m=function(h){return Promise.all(h.map(p=>Promise.resolve(p).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};var r=m;document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));a=m(t.map(h=>{if(h=N(h),h in S)return;S[h]=!0;const p=h.endsWith(".css"),y=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${y}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":D,p||(u.as="script"),u.crossOrigin="",u.href=h,d&&u.setAttribute("nonce",d),document.head.appendChild(u),p)return new Promise((T,B)=>{u.addEventListener("load",T),u.addEventListener("error",()=>B(new Error(`Unable to preload CSS for ${h}`)))})}))}function n(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return a.then(o=>{for(const d of o||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})},V=l=>{let e;const t=new Set,i=(m,h)=>{const p=typeof m=="function"?m(e):m;if(!Object.is(p,e)){const y=e;e=(h!=null?h:typeof p!="object"||p===null)?p:Object.assign({},e,p),t.forEach(u=>u(e,y))}},a=()=>e,o={setState:i,getState:a,getInitialState:()=>d,subscribe:m=>(t.add(m),()=>t.delete(m))},d=e=l(i,a,o);return o},H=(l=>V);class c{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const i=this.getCapybaraWidth(),a=this.getCapybaraHeight(),n=this.getCapybaraBottom();return{x:e,y:t-n-a,width:i,height:a}}static calculateFillPercentage(e){return Math.min(100,e/this.LEVEL_UP_THRESHOLD*100)}static getPointsForLevelUp(){return this.LEVEL_UP_THRESHOLD}}s(c,"MOBILE_BREAKPOINT",768),s(c,"CAPYBARA_WIDTH_DESKTOP",100),s(c,"CAPYBARA_HEIGHT_DESKTOP",75),s(c,"CAPYBARA_WIDTH_MOBILE",100),s(c,"CAPYBARA_HEIGHT_MOBILE",75),s(c,"CAPYBARA_BOTTOM_DESKTOP",20),s(c,"CAPYBARA_BOTTOM_MOBILE",10),s(c,"VEGETABLE_SIZE_DESKTOP",50),s(c,"VEGETABLE_SIZE_MOBILE",40),s(c,"PLAYER_SPEED",8),s(c,"SPAWN_RATE_BASE",2e3),s(c,"SPAWN_RATE_DECREASE",100),s(c,"MIN_SPAWN_RATE",800),s(c,"LEVEL_UP_THRESHOLD",50),s(c,"AUDIO_ENABLED_DEFAULT",!0),s(c,"MASTER_VOLUME",.6),s(c,"ANIMATION_DURATION_FAST",300),s(c,"ANIMATION_DURATION_NORMAL",600),s(c,"ANIMATION_DURATION_SLOW",1e3),s(c,"REDUCE_ANIMATIONS",!1);const L=H()(l=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100,incrementLevel:()=>l(e=>({level:e.level+1,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>l(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>l(t=>{const i=t.score+e,a=t.capybaraFillPercentage+e,n=a>=c.LEVEL_UP_THRESHOLD;return{score:i,capybaraFillPercentage:n?c.LEVEL_UP_THRESHOLD:a,gameStatus:n?"won":t.gameStatus}}),resetForNextLevel:()=>l(()=>({capybaraFillPercentage:0,missedVegetables:0,gameStatus:"playing"})),resetGame:()=>l(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",ceilingHeight:100})),pauseGame:()=>l(()=>({gameStatus:"paused"})),resumeGame:()=>l(()=>({gameStatus:"playing"}))}));class I{constructor(){s(this,"level",1);s(this,"score",0);s(this,"missedVegetables",0);s(this,"capybaraFillPercentage",0);s(this,"gameStatus","playing");s(this,"fallSpeed",2);s(this,"ceilingHeight",100);s(this,"vegetables",[]);s(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const x=new I;class R{constructor(e){s(this,"element");s(this,"fillElement");s(this,"svgElement");s(this,"x",0);s(this,"lastX",0);s(this,"gameContainer");s(this,"speed",8);s(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-c.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
      position: absolute;
      bottom: 0;
      left: 0;
      width: 100%;
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),i=this.element.querySelector("#pauseHelpBtn"),a=()=>{this.hide(),e()};t.addEventListener("click",a),t.addEventListener("touchend",r=>{r.preventDefault(),a()}),i&&this.onShowHelp&&i.addEventListener("click",this.onShowHelp);const n=r=>{r.code==="Space"&&(r.preventDefault(),a(),document.removeEventListener("keydown",n))};document.addEventListener("keydown",n)}}class A{constructor(){s(this,"element")}show(){this.createElement(),document.body.appendChild(this.element),setTimeout(()=>{this.element.classList.add("help-modal--show")},50)}hide(){this.element&&(this.element.classList.remove("help-modal--show"),setTimeout(()=>{this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)},300))}createElement(){this.element=document.createElement("div"),this.element.className="help-modal",this.element.innerHTML=`
    ...
    `;const e=this.element.querySelector(".help-modal__close"),t=this.element.querySelector(".help-modal__backdrop"),i=()=>this.hide();e.addEventListener("click",i),t.addEventListener("click",i);const a=n=>{n.key==="Escape"&&(i(),document.removeEventListener("keydown",a))};document.addEventListener("keydown",a)}}const v=class v{constructor(){s(this,"enabled",!0);s(this,"audioContext",null);s(this,"initialized",!1);this.setupMobileAudioInit()}static getInstance(){return v.instance||(v.instance=new v),v.instance}setupMobileAudioInit(){const e=/iPad|iPhone|iPod/.test(navigator.userAgent),t=()=>g(this,null,function*(){this.initialized||(console.log("Initializing audio for mobile, iOS detected:",e),yield this.init(),this.initialized=!0,e&&setTimeout(()=>g(this,null,function*(){try{yield this.playUnlockSound()}catch(i){console.warn("Additional iOS unlock failed:",i)}}),200),document.removeEventListener("touchstart",t),document.removeEventListener("click",t))});document.addEventListener("touchstart",t,{once:!0}),document.addEventListener("click",t,{once:!0})}play(e){return g(this,null,function*(){if(this.enabled)try{if(this.initialized||(yield this.init(),this.initialized=!0),(!this.audioContext||this.audioContext.state==="closed")&&(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&(yield this.audioContext.resume()),this.audioContext.state!=="running"){console.warn("AudioContext not running, skipping sound");return}const t=this.audioContext.createOscillator(),i=this.audioContext.createGain();t.connect(i),i.connect(this.audioContext.destination);const n={catch:{freq:800,duration:.1},miss:{freq:200,duration:.2},levelup:{freq:1e3,duration:.3},gameover:{freq:150,duration:.5},click:{freq:600,duration:.05}}[e];if(!n)return;t.frequency.value=n.freq,t.type="sine",i.gain.setValueAtTime(0,this.audioContext.currentTime),i.gain.linearRampToValueAtTime(.3,this.audioContext.currentTime+.01),i.gain.exponentialRampToValueAtTime(.01,this.audioContext.currentTime+n.duration),t.start(),t.stop(this.audioContext.currentTime+n.duration)}catch(t){console.warn("Audio playback failed:",t)}})}toggle(){return this.enabled=!this.enabled,this.enabled}isEnabled(){return this.enabled}init(){return g(this,null,function*(){try{this.audioContext||(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&(yield this.audioContext.resume()),this.initialized||(yield this.playUnlockSound())}catch(e){console.warn("Audio initialization failed:",e)}})}playUnlockSound(){return g(this,null,function*(){try{if(!this.audioContext||this.audioContext.state!=="running")return;const e=this.audioContext.createOscillator(),t=this.audioContext.createGain();e.connect(t),t.connect(this.audioContext.destination),e.frequency.value=440,e.type="sine",t.gain.setValueAtTime(.001,this.audioContext.currentTime),t.gain.exponentialRampToValueAtTime(.001,this.audioContext.currentTime+.01),e.start(),e.stop(this.audioContext.currentTime+.01),console.log("iOS audio unlock sound played")}catch(e){console.warn("iOS audio unlock failed:",e)}})}};s(v,"instance");let f=v;const U=Object.freeze(Object.defineProperty({__proto__:null,AudioManager:f},Symbol.toStringTag,{value:"Module"}));class K{constructor(e){s(this,"container");s(this,"player");s(this,"spawner");s(this,"particles");s(this,"hud");s(this,"gameOverScreen");s(this,"levelTransition");s(this,"pauseOverlay");s(this,"helpModal");s(this,"audioManager",f.getInstance());s(this,"animationId",0);s(this,"lastTime",0);s(this,"vegetables",[]);s(this,"gameStore",L);s(this,"levelTransitionActive",!1);this.container=e,this.init()}init(){this.player=new R(this.container),this.spawner=new Q(this.container),this.particles=new z(this.container),this.hud=new q(this.container),this.gameOverScreen=new W(this.container,()=>this.restart()),this.levelTransition=new G(this.container),this.pauseOverlay=new $(this.container,()=>this.helpModal.show()),this.helpModal=new A,L.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"&&!this.levelTransitionActive?(this.levelTransitionActive=!0,this.audioManager.play("levelup"),this.clearAllVegetables(),this.levelTransition.show(e.level+1),setTimeout(()=>{this.gameStore.getState().incrementLevel(),this.gameStore.getState().resetForNextLevel(),this.levelTransitionActive=!1},2e3)):e.gameStatus==="lost"&&(this.audioManager.play("gameover"),this.gameOverScreen.show(!1,e.score,e.level))}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const i=this.gameStore.getState();(i.gameStatus==="lost"||i.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const i=this.gameStore.getState();i.gameStatus==="playing"&&!this.levelTransitionActive?(this.update(t),this.render()):i.gameStatus,this.animationId=requestAnimationFrame(a=>this.gameLoop(a))}update(e){const t=this.gameStore.getState();if(t.gameStatus!=="playing"||this.levelTransitionActive)return;const i=this.spawner.update(e,t.level);this.vegetables.push(...i),this.vegetables=this.vegetables.filter(r=>{const o=r.y+r.speed;if(this.gameStore.getState().gameStatus!=="playing"||this.levelTransitionActive)return this.spawner.removeVegetable(r.id),!1;const m=this.player.getBounds();if(this.checkCollision(m,C(E({},r),{y:o}))){this.audioManager.play("catch"),t.updateScore(r.points),this.particles.createCatchEffect(r.x,o),this.spawner.removeVegetable(r.id);const h=this.container.querySelector(".capybara-player");return h&&(h.classList.add("capybara-player--catch"),setTimeout(()=>{h.classList.remove("capybara-player--catch")},600)),this.createScorePopup(r.x,o,r.points),!1}return o>this.container.clientHeight?(this.audioManager.play("miss"),t.incrementMissed(),this.spawner.removeVegetable(r.id),!1):(r.y=o,this.spawner.updateVegetablePosition(r),!0)}),this.particles.update();const a=this.gameStore.getState();this.hud.updateScore(a.score),this.hud.updateLevel(a.level),this.hud.updateLives(3-a.missedVegetables);const n=c.calculateFillPercentage(a.capybaraFillPercentage);this.hud.updateProgress(n),this.player.updateFill(n)}render(){this.particles.render()}checkCollision(e,t){const i=c.getVegetableSize(),a=.3,n=Math.max(0,Math.min(e.x+e.width,t.x+i)-Math.max(e.x,t.x)),r=Math.max(0,Math.min(e.y+e.height,t.y+i)-Math.max(e.y,t.y)),d=Math.min(e.width*e.height,i*i)*a;return n*r>=d}clearAllVegetables(){this.vegetables=[],this.spawner.reset()}restart(){this.clearAllVegetables(),this.gameStore.getState().resetGame(),this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}createScorePopup(e,t,i){const a=document.createElement("div");a.className="score-popup",a.textContent=`+${i}`,a.style.cssText=`
      position: absolute;
      left: ${e}px;
      top: ${t}px;
      color: #FFD700;
    ...
    `,this.element.addEventListener("click",e=>{e.stopPropagation(),e.preventDefault(),this.toggleAudio()}),this.element.addEventListener("touchend",e=>{e.stopPropagation(),e.preventDefault(),this.toggleAudio()}),this.element.addEventListener("mouseenter",()=>{this.element.style.transform="scale(1.1)"}),this.element.addEventListener("mouseleave",()=>{this.element.style.transform="scale(1)"})}toggleAudio(){return g(this,null,function*(){try{const e=this.audioManager.toggle();this.element.innerHTML=e?"🔊":"🔇",this.element.style.opacity=e?"1":"0.6",e&&(yield this.audioManager.init(),yield this.audioManager.play("click"))}catch(e){console.warn("Audio toggle failed:",e)}})}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class X{constructor(){s(this,"gameEngine",null);s(this,"container");s(this,"helpModal");s(this,"_audioToggle");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.helpModal=new A,this._audioToggle=new Y(document.body),this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),i=e.querySelector("#helpButton"),a=()=>{e.remove(),this.startGame()},n=r=>g(this,null,function*(){r&&r.preventDefault();try{const o=(yield O(()=>g(this,null,function*(){const{AudioManager:d}=yield Promise.resolve().then(()=>U);return{AudioManager:d}}),void 0)).AudioManager.getInstance();yield o.init(),yield new Promise(d=>setTimeout(d,100)),yield o.play("click"),console.log("Audio initialized successfully for iOS")}catch(o){console.warn("Audio initialization failed:",o)}a()});t.addEventListener("click",n),t.addEventListener("touchend",n),i.addEventListener("click",()=>{this.helpModal.show()}),t.addEventListener("click",()=>{}),i.addEventListener("click",()=>{}),e.addEventListener("touchmove",r=>{r.preventDefault()}),e.addEventListener("click",r=>{r.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new K(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new X});window.addEventListener("resize",()=>{const l=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");l&&e&&(l.width=e.clientWidth,l.height=e.clientHeight)});
//# sourceMappingURL=index-BWC9GPQY.js.map
