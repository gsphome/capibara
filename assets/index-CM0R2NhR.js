var E=Object.defineProperty;var w=(n,e,t)=>e in n?E(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var i=(n,e,t)=>w(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=t(a);fetch(a.href,l)}})();const C=n=>{let e;const t=new Set,s=(h,y)=>{const p=typeof h=="function"?h(e):h;if(!Object.is(p,e)){const b=e;e=(y!=null?y:typeof p!="object"||p===null)?p:Object.assign({},e,p),t.forEach(x=>x(e,b))}},a=()=>e,c={setState:s,getState:a,getInitialState:()=>u,subscribe:h=>(t.add(h),()=>t.delete(h))},u=e=n(s,a,c);return c},S=(n=>C);class r{static isMobile(){return window.innerWidth<=this.MOBILE_BREAKPOINT}static getCapybaraWidth(){return this.isMobile()?this.CAPYBARA_WIDTH_MOBILE:this.CAPYBARA_WIDTH_DESKTOP}static getCapybaraHeight(){return this.isMobile()?this.CAPYBARA_HEIGHT_MOBILE:this.CAPYBARA_HEIGHT_DESKTOP}static getCapybaraBottom(){return this.isMobile()?this.CAPYBARA_BOTTOM_MOBILE:this.CAPYBARA_BOTTOM_DESKTOP}static getVegetableSize(){return this.isMobile()?this.VEGETABLE_SIZE_MOBILE:this.VEGETABLE_SIZE_DESKTOP}static getCapybaraBounds(e,t){const s=this.getCapybaraWidth(),a=this.getCapybaraHeight(),l=this.getCapybaraBottom();return{x:e,y:t-l-a,width:s,height:a}}}i(r,"MOBILE_BREAKPOINT",768),i(r,"CAPYBARA_WIDTH_DESKTOP",100),i(r,"CAPYBARA_HEIGHT_DESKTOP",75),i(r,"CAPYBARA_WIDTH_MOBILE",100),i(r,"CAPYBARA_HEIGHT_MOBILE",75),i(r,"CAPYBARA_BOTTOM_DESKTOP",20),i(r,"CAPYBARA_BOTTOM_MOBILE",10),i(r,"VEGETABLE_SIZE_DESKTOP",50),i(r,"VEGETABLE_SIZE_MOBILE",40),i(r,"PLAYER_SPEED",8),i(r,"SPAWN_RATE_BASE",2e3),i(r,"SPAWN_RATE_DECREASE",100),i(r,"MIN_SPAWN_RATE",800),i(r,"LEVEL_UP_THRESHOLD",50),i(r,"AUDIO_ENABLED_DEFAULT",!0),i(r,"MASTER_VOLUME",.6),i(r,"ANIMATION_DURATION_FAST",300),i(r,"ANIMATION_DURATION_NORMAL",600),i(r,"ANIMATION_DURATION_SLOW",1e3),i(r,"REDUCE_ANIMATIONS",!1);const v=S()(n=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[],addVegetable:e=>n(t=>({vegetables:[...t.vegetables,e]})),removeVegetable:e=>n(t=>({vegetables:t.vegetables.filter(s=>s.id!==e)})),incrementLevel:()=>n(e=>({level:e.level+1,fallSpeed:e.fallSpeed*1.15,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>n(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>n(t=>{const s=Math.min(100,t.capybaraFillPercentage+e);return{score:t.score+e,capybaraFillPercentage:s,gameStatus:s>=r.LEVEL_UP_THRESHOLD?"won":t.gameStatus}}),resetForNextLevel:()=>n(()=>({capybaraFillPercentage:0,missedVegetables:0,vegetables:[],gameStatus:"playing"})),resetGame:()=>n(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[]})),pauseGame:()=>n(()=>({gameStatus:"paused"})),resumeGame:()=>n(()=>({gameStatus:"playing"}))}));class L{constructor(){i(this,"level",1);i(this,"score",0);i(this,"missedVegetables",0);i(this,"capybaraFillPercentage",0);i(this,"gameStatus","playing");i(this,"fallSpeed",2);i(this,"ceilingHeight",100);i(this,"vegetables",[]);i(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const g=new L;class B{constructor(e){i(this,"element");i(this,"fillElement");i(this,"svgElement");i(this,"x",0);i(this,"lastX",0);i(this,"gameContainer");i(this,"speed",8);i(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-r.getCapybaraWidth()/2,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
      position: absolute;
      bottom: 0;
      left: 0;
      width: 100%;
    ...
    `,e.appendChild(this.fillElement),e.appendChild(this.svgElement),this.element.appendChild(e),this.updatePosition()}setupControls(){document.addEventListener("keydown",t=>{if(g.gameStatus==="playing")switch(t.key){case"ArrowLeft":case"a":case"A":this.moveLeft();break;case"ArrowRight":case"d":case"D":this.moveRight();break}}),document.addEventListener("mousemove",t=>{if(g.gameStatus!=="playing")return;const s=this.gameContainer.getBoundingClientRect(),a=t.clientX-s.left,l=r.getCapybaraWidth(),o=l/2;this.x=Math.max(0,Math.min(this.gameContainer.clientWidth-l,a-o)),this.updatePosition()});let e=!1;document.addEventListener("touchstart",t=>{const s=t.target;s.closest(".pause-overlay")||s.closest(".game-over")||s.closest(".level-transition")||(e=!0,t.preventDefault())},{passive:!1}),document.addEventListener("touchmove",t=>{if(!e||g.gameStatus!=="playing")return;const s=t.target;if(s.closest(".pause-overlay")||s.closest(".game-over")||s.closest(".level-transition"))return;const a=t.touches[0],l=this.gameContainer.getBoundingClientRect(),o=a.clientX-l.left,c=r.getCapybaraWidth(),u=c/2;this.x=Math.max(0,Math.min(this.gameContainer.clientWidth-c,o-u)),this.updatePosition(),t.preventDefault()},{passive:!1}),document.addEventListener("touchend",()=>{e=!1})}moveLeft(){this.x=Math.max(0,this.x-this.speed),this.updatePosition()}moveRight(){const e=r.getCapybaraWidth();this.x=Math.min(this.gameContainer.clientWidth-e,this.x+this.speed),this.updatePosition()}updatePosition(){this.element.style.left=`${this.x}px`;const e=this.x>this.lastX?"right":this.x<this.lastX?"left":this.direction;if(e!==this.direction){this.direction=e;const t=this.svgElement.querySelector("use");t&&t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",`#capybara-${this.direction}`),this.element.classList.add("capybara-player--running"),setTimeout(()=>{this.element.classList.remove("capybara-player--running")},300)}this.lastX=this.x}updateFill(e){this.fillElement.style.height=`${e}%`,e>=80?this.fillElement.style.background="linear-gradient(45deg, #FFD700, #FFA500)":e>=50&&(this.fillElement.style.background="linear-gradient(45deg, #ADFF2F, #32CD32)")}getBounds(){return r.getCapybaraBounds(this.x,this.gameContainer.clientHeight)}getX(){return this.x}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class F{constructor(e){i(this,"container");i(this,"spawnTimer",0);i(this,"vegetableTypes",["carrot","broccoli","lettuce","tomato","pepper"]);i(this,"activeVegetables",new Map);this.container=e}update(e,t){this.spawnTimer+=e;const s=Math.max(800,2e3-t*100),a=[];if(this.spawnTimer>=s){const l=this.spawnVegetable(t);a.push(l),this.spawnTimer=0}return a}spawnVegetable(e){const t=this.vegetableTypes[Math.floor(Math.random()*this.vegetableTypes.length)],s=Math.random()*(this.container.clientWidth-r.getVegetableSize()),a={id:Date.now().toString()+Math.random(),type:t,x:s,y:-r.getVegetableSize(),speed:2+e*.3,points:this.getVegetablePoints(t)};return this.createVegetableElement(a),a}createVegetableElement(e){const t=document.createElement("div");t.className=`vegetable vegetable--${e.type} vegetable--spawning`,t.style.left=`${e.x}px`,t.style.top=`${e.y}px`,t.id=e.id;const s=document.createElementNS("http://www.w3.org/2000/svg","svg");s.setAttribute("viewBox","0 0 30 30"),s.setAttribute("width",r.getVegetableSize().toString()),s.setAttribute("height",r.getVegetableSize().toString());const a=document.createElementNS("http://www.w3.org/2000/svg","use");a.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",`#${e.type}`),s.appendChild(a),t.appendChild(s),this.container.appendChild(t),this.activeVegetables.set(e.id,t),setTimeout(()=>{t.classList.remove("vegetable--spawning")},300)}updateVegetablePosition(e){const t=this.activeVegetables.get(e.id);t&&(t.style.top=`${e.y}px`)}removeVegetable(e){const t=this.activeVegetables.get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),this.activeVegetables.delete(e))}getVegetablePoints(e){return{carrot:5,broccoli:8,lettuce:3,tomato:6,pepper:10}[e]||5}}class T{constructor(e){i(this,"particles",[]);i(this,"canvas");i(this,"ctx");this.canvas=document.createElement("canvas"),this.canvas.className="particle-canvas",this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight,this.canvas.style.position="absolute",this.canvas.style.top="0",this.canvas.style.left="0",this.canvas.style.pointerEvents="none",this.canvas.style.zIndex="15",e.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),window.addEventListener("resize",()=>{this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight})}createCatchEffect(e,t){for(let s=0;s<8;s++)this.particles.push({x:e+15,y:t+15,vx:(Math.random()-.5)*6,vy:(Math.random()-.5)*6,life:30,maxLife:30,color:`hsl(${Math.random()*60+60}, 70%, 60%)`})}update(){this.particles=this.particles.filter(e=>(e.x+=e.vx,e.y+=e.vy,e.vy+=.1,e.life--,e.life>0))}render(){this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.particles.forEach(e=>{const t=e.life/e.maxLife;this.ctx.globalAlpha=t,this.ctx.fillStyle=e.color,this.ctx.fillRect(e.x,e.y,4,4)}),this.ctx.globalAlpha=1}destroy(){this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas)}}class k{constructor(e){i(this,"element");i(this,"scoreElement");i(this,"levelElement");i(this,"missedElement");i(this,"progressBar");i(this,"progressFill");const t=document.querySelector(".game-hud");t&&t.remove(),this.createElement();let s=document.querySelector(".game-wrapper"),a=document.querySelector(".game-sidebar");s?a&&a.appendChild(this.element):(s=document.createElement("div"),s.className="game-wrapper",a=document.createElement("div"),a.className="game-sidebar",a.appendChild(this.element),s.appendChild(a),s.appendChild(e),document.body.appendChild(s))}createElement(){this.element=document.createElement("div"),this.element.className="game-hud",this.scoreElement=document.createElement("div"),this.scoreElement.className="game-hud__score",this.scoreElement.innerHTML="Score<br>0",this.levelElement=document.createElement("div"),this.levelElement.className="game-hud__level",this.levelElement.innerHTML="Level<br>1",this.missedElement=document.createElement("div"),this.missedElement.className="game-hud__lives",this.updateLives(3);const e=document.createElement("div");e.className="game-hud__row",e.appendChild(this.scoreElement),e.appendChild(this.levelElement),e.appendChild(this.missedElement),this.element.appendChild(e);const t=document.createElement("div");t.className="progress-bar",this.progressFill=document.createElement("div"),this.progressFill.className="progress-bar__fill",this.progressFill.style.width="0%",t.appendChild(this.progressFill),this.element.appendChild(t),this.progressBar=t}updateScore(e){this.scoreElement.innerHTML=`Score<br>${e}`}updateLevel(e){this.levelElement.innerHTML=`Level<br>${e}`}updateLives(e){const t=[];for(let s=0;s<3;s++)s<e?t.push("❤️"):t.push("🤍");this.missedElement.innerHTML=t.join(" ")}updateProgress(e){this.progressFill.style.width=`${e}%`,e>=100&&(this.progressFill.style.background="linear-gradient(90deg, #FFD700, #FFA500)")}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element),this.progressBar.parentNode&&this.progressBar.parentNode.removeChild(this.progressBar)}}class _{constructor(e,t){i(this,"element");i(this,"onRestart");this.onRestart=t,this.createElement(),e.appendChild(this.element),this.hide()}createElement(){this.element=document.createElement("div"),this.element.className="game-over";const e=document.createElement("h1");e.className="game-over__title";const t=document.createElement("div");t.className="game-over__score";const s=document.createElement("button");s.className="game-over__button",s.textContent="Play Again",s.addEventListener("click",this.onRestart),this.element.appendChild(e),this.element.appendChild(t),this.element.appendChild(s)}show(e,t,s){const a=this.element.querySelector(".game-over__title"),l=this.element.querySelector(".game-over__score");e?(a.textContent="🎉 You Win! 🎉",a.style.color="#FFD700",l.textContent=`Capybara is full! Final Score: ${t} (Level ${s})`):(a.textContent="💔 Game Over 💔",a.style.color="#FF4444",l.textContent=`Too many vegetables missed! Final Score: ${t} (Level ${s})`),this.element.style.display="flex"}hide(){this.element.style.display="none"}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class A{constructor(e){i(this,"element");i(this,"container");this.container=e}show(e){this.createElement(e),this.container.appendChild(this.element),setTimeout(()=>{this.element.classList.add("level-transition--show")},50),setTimeout(()=>{this.hide()},2e3)}createElement(e){this.element=document.createElement("div"),this.element.className="level-transition",this.element.innerHTML=`
      <div class="level-transition__content">
        <h1>Level ${e}</h1>
        <p>Let's go!</p>
      </div>
    `}hide(){this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class M{constructor(e,t){i(this,"element");i(this,"container");i(this,"onShowHelp");this.container=e,this.onShowHelp=t}show(e){this.createElement(e),this.container.appendChild(this.element),setTimeout(()=>{this.element.classList.add("pause-overlay--show")},50)}hide(){this.element&&(this.element.classList.remove("pause-overlay--show"),setTimeout(()=>{this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)},300))}createElement(e){this.element=document.createElement("div"),this.element.className="pause-overlay",this.element.innerHTML=`
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),s=this.element.querySelector("#pauseHelpBtn"),a=()=>{this.hide(),e()};t.addEventListener("click",a),t.addEventListener("touchend",o=>{o.preventDefault(),a()}),s&&this.onShowHelp&&s.addEventListener("click",this.onShowHelp);const l=o=>{o.code==="Space"&&(o.preventDefault(),a(),document.removeEventListener("keydown",l))};document.addEventListener("keydown",l)}}class f{constructor(){i(this,"element")}show(){this.createElement(),document.body.appendChild(this.element),setTimeout(()=>{this.element.classList.add("help-modal--show")},50)}hide(){this.element&&(this.element.classList.remove("help-modal--show"),setTimeout(()=>{this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)},300))}createElement(){this.element=document.createElement("div"),this.element.className="help-modal",this.element.innerHTML=`
    ...
    `;const e=this.element.querySelector(".help-modal__close"),t=this.element.querySelector(".help-modal__backdrop"),s=()=>this.hide();e.addEventListener("click",s),t.addEventListener("click",s);const a=l=>{l.key==="Escape"&&(s(),document.removeEventListener("keydown",a))};document.addEventListener("keydown",a)}}const d=class d{constructor(){i(this,"enabled",!0);i(this,"audioContext",null)}static getInstance(){return d.instance||(d.instance=new d),d.instance}play(e){if(this.enabled)try{(!this.audioContext||this.audioContext.state==="closed")&&(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&this.audioContext.resume();const t=this.audioContext.createOscillator(),s=this.audioContext.createGain();t.connect(s),s.connect(this.audioContext.destination);const l={catch:{freq:800,duration:.1},miss:{freq:200,duration:.2},levelup:{freq:1e3,duration:.3},gameover:{freq:150,duration:.5},click:{freq:600,duration:.05}}[e];if(!l)return;t.frequency.value=l.freq,t.type="sine",s.gain.setValueAtTime(0,this.audioContext.currentTime),s.gain.linearRampToValueAtTime(.3,this.audioContext.currentTime+.01),s.gain.exponentialRampToValueAtTime(.01,this.audioContext.currentTime+l.duration),t.start(),t.stop(this.audioContext.currentTime+l.duration)}catch(t){console.warn("Audio playback failed:",t)}}toggle(){return this.enabled=!this.enabled,this.enabled}isEnabled(){return this.enabled}};i(d,"instance");let m=d;class D{constructor(e){i(this,"element");i(this,"audioManager",m.getInstance());this.createElement(),e.appendChild(this.element)}createElement(){this.element=document.createElement("button"),this.element.className="audio-toggle",this.element.innerHTML="🔊",this.element.style.cssText=`
      position: fixed;
      top: 10px;
      right: 10px;
    ...
    `,this.element.addEventListener("click",()=>{this.audioManager.play("click");const e=this.audioManager.toggle();this.element.innerHTML=e?"🔊":"🔇",this.element.style.opacity=e?"1":"0.6"}),this.element.addEventListener("mouseenter",()=>{this.element.style.transform="scale(1.1)"}),this.element.addEventListener("mouseleave",()=>{this.element.style.transform="scale(1)"})}destroy(){this.element.parentNode&&this.element.parentNode.removeChild(this.element)}}class N{constructor(e){i(this,"container");i(this,"player");i(this,"spawner");i(this,"particles");i(this,"hud");i(this,"gameOverScreen");i(this,"levelTransition");i(this,"pauseOverlay");i(this,"helpModal");i(this,"audioToggle");i(this,"audioManager",m.getInstance());i(this,"animationId",0);i(this,"lastTime",0);i(this,"vegetables",[]);i(this,"gameStore",v);i(this,"levelTransitionActive",!1);this.container=e,this.init()}init(){this.player=new B(this.container),this.spawner=new F(this.container),this.particles=new T(this.container),this.hud=new k(this.container),this.gameOverScreen=new _(this.container,()=>this.restart()),this.levelTransition=new A(this.container),this.pauseOverlay=new M(this.container,()=>this.helpModal.show()),this.helpModal=new f,this.audioToggle=new D(document.body),v.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"&&!this.levelTransitionActive?(this.levelTransitionActive=!0,this.audioManager.play("levelup"),this.levelTransition.show(e.level+1),setTimeout(()=>{this.gameStore.getState().incrementLevel(),this.gameStore.getState().resetForNextLevel(),this.levelTransitionActive=!1},2e3)):e.gameStatus==="lost"&&(this.audioManager.play("gameover"),this.gameOverScreen.show(!1,e.score,e.level))}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const s=this.gameStore.getState();(s.gameStatus==="lost"||s.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const s=this.gameStore.getState();s.gameStatus==="playing"?(this.update(t),this.render()):s.gameStatus,this.animationId=requestAnimationFrame(a=>this.gameLoop(a))}update(e){const t=this.gameStore.getState(),s=this.spawner.update(e,t.level);this.vegetables.push(...s),this.vegetables=this.vegetables.filter(l=>{l.y+=l.speed,this.spawner.updateVegetablePosition(l);const o=this.player.getBounds();if(this.checkCollision(o,l)){this.audioManager.play("catch"),t.updateScore(l.points),this.particles.createCatchEffect(l.x,l.y),this.spawner.removeVegetable(l.id);const c=this.container.querySelector(".capybara-player");return c&&(c.classList.add("capybara-player--catch"),setTimeout(()=>{c.classList.remove("capybara-player--catch")},600)),this.createScorePopup(l.x,l.y,l.points),!1}return l.y>this.container.clientHeight?(this.audioManager.play("miss"),t.incrementMissed(),this.spawner.removeVegetable(l.id),!1):!0}),this.particles.update();const a=this.gameStore.getState();this.hud.updateScore(a.score),this.hud.updateLevel(a.level),this.hud.updateLives(3-a.missedVegetables),this.hud.updateProgress(a.capybaraFillPercentage),this.player.updateFill(a.capybaraFillPercentage)}render(){this.particles.render()}checkCollision(e,t){return t.x<e.x+e.width&&t.x+30>e.x&&t.y<e.y+e.height&&t.y+30>e.y}restart(){this.gameStore.getState().resetGame(),this.vegetables.forEach(e=>{this.spawner.removeVegetable(e.id)}),this.vegetables=[],this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}createScorePopup(e,t,s){const a=document.createElement("div");a.className="score-popup",a.textContent=`+${s}`,a.style.cssText=`
      ...
      pointer-events: none;
      z-index: 1000;
    `,this.container.appendChild(a),setTimeout(()=>{a.parentNode&&a.parentNode.removeChild(a)},1e3)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy(),this.audioToggle.destroy()}}class P{constructor(){i(this,"gameEngine",null);i(this,"container");i(this,"helpModal");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.helpModal=new f,this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),s=e.querySelector("#helpButton"),a=()=>{e.remove(),this.startGame()};t.addEventListener("click",a),t.addEventListener("touchend",l=>{l.preventDefault(),a()}),s.addEventListener("click",()=>{this.helpModal.show()}),t.addEventListener("click",()=>{}),s.addEventListener("click",()=>{}),e.addEventListener("touchmove",l=>{l.preventDefault()}),e.addEventListener("click",l=>{l.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new N(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new P});window.addEventListener("resize",()=>{const n=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");n&&e&&(n.width=e.clientWidth,n.height=e.clientHeight)});
