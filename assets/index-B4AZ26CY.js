var w=Object.defineProperty;var E=(a,e,t)=>e in a?w(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var l=(a,e,t)=>E(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const y=a=>{let e;const t=new Set,s=(c,u)=>{const d=typeof c=="function"?c(e):c;if(!Object.is(d,e)){const b=e;e=(u!=null?u:typeof d!="object"||d===null)?d:Object.assign({},e,d),t.forEach(x=>x(e,b))}},i=()=>e,o={setState:s,getState:i,getInitialState:()=>m,subscribe:c=>(t.add(c),()=>t.delete(c))},m=e=a(s,i,o);return o},S=(a=>a?y(a):y),p={};throw new Error('Could not resolve "react" imported by "zustand".');const C=a=>a;function F(a,e=C){const t=p.useSyncExternalStore(a.subscribe,p.useCallback(()=>e(a.getState()),[a,e]),p.useCallback(()=>e(a.getInitialState()),[a,e]));return p.useDebugValue(t),t}const f=a=>{const e=S(a),t=s=>F(e,s);return Object.assign(t,e),t},k=(a=>a?f(a):f),v=k(a=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[],addVegetable:e=>a(t=>({vegetables:[...t.vegetables,e]})),removeVegetable:e=>a(t=>({vegetables:t.vegetables.filter(s=>s.id!==e)})),incrementLevel:()=>a(e=>({level:e.level+1,fallSpeed:e.fallSpeed*1.15,ceilingHeight:Math.max(50,e.ceilingHeight*.9)})),incrementMissed:()=>a(e=>{const t=e.missedVegetables+1;return{missedVegetables:t,gameStatus:t>=3?"lost":e.gameStatus}}),updateScore:e=>a(t=>{const s=Math.min(100,t.capybaraFillPercentage+e);return{score:t.score+e,capybaraFillPercentage:s,gameStatus:s>=100?"won":t.gameStatus}}),resetForNextLevel:()=>a(()=>({capybaraFillPercentage:0,missedVegetables:0,vegetables:[],gameStatus:"playing"})),resetGame:()=>a(()=>({level:1,score:0,missedVegetables:0,capybaraFillPercentage:0,gameStatus:"playing",fallSpeed:2,ceilingHeight:100,vegetables:[]})),pauseGame:()=>a(()=>({gameStatus:"paused"})),resumeGame:()=>a(()=>({gameStatus:"playing"}))}));class L{constructor(){l(this,"level",1);l(this,"score",0);l(this,"missedVegetables",0);l(this,"capybaraFillPercentage",0);l(this,"gameStatus","playing");l(this,"fallSpeed",2);l(this,"ceilingHeight",100);l(this,"vegetables",[]);l(this,"listeners",[])}addListener(e){this.listeners.push(e)}removeListener(e){this.listeners=this.listeners.filter(t=>t!==e)}notify(){this.listeners.forEach(e=>e())}addVegetable(e){this.vegetables.push(e),this.notify()}removeVegetable(e){this.vegetables=this.vegetables.filter(t=>t.id!==e),this.notify()}incrementLevel(){this.level+=1,this.fallSpeed*=1.15,this.ceilingHeight=Math.max(50,this.ceilingHeight*.9),this.notify()}incrementMissed(){this.missedVegetables+=1,this.missedVegetables>=3&&(this.gameStatus="lost"),this.notify()}updateScore(e){this.score+=e,this.capybaraFillPercentage=Math.min(100,this.capybaraFillPercentage+e),this.capybaraFillPercentage>=100&&(this.gameStatus="won",this.incrementLevel()),this.notify()}resetForNextLevel(){this.capybaraFillPercentage=0,this.missedVegetables=0,this.vegetables=[],this.notify()}resetGame(){this.level=1,this.score=0,this.missedVegetables=0,this.capybaraFillPercentage=0,this.gameStatus="playing",this.fallSpeed=2,this.ceilingHeight=100,this.vegetables=[],setTimeout(()=>this.notify(),100)}pauseGame(){this.gameStatus="paused",this.notify()}resumeGame(){this.gameStatus="playing",this.notify()}}const g=new L;class B{constructor(e){l(this,"element");l(this,"fillElement");l(this,"svgElement");l(this,"x",0);l(this,"lastX",0);l(this,"gameContainer");l(this,"speed",8);l(this,"direction","right");this.gameContainer=e,this.x=this.gameContainer.clientWidth/2-50,this.lastX=this.x,this.createElement(),e.appendChild(this.element),this.setupControls()}createElement(){this.element=document.createElement("div"),this.element.className="capybara-player";const e=document.createElement("div");e.className="capybara-player__body",this.svgElement=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.svgElement.setAttribute("class","capybara-player__svg"),this.svgElement.setAttribute("viewBox","0 0 80 60");const t=document.createElementNS("http://www.w3.org/2000/svg","use");t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#capybara-right"),this.svgElement.appendChild(t),this.fillElement=document.createElement("div"),this.fillElement.className="capybara-player__fill",this.fillElement.style.cssText=`
      position: absolute;
      bottom: 0;
      left: 0;
      width: 100%;
    ...
    `;const t=this.element.querySelector(".pause-overlay__resume-btn"),s=()=>{this.hide(),e()};t.addEventListener("click",s),t.addEventListener("touchend",r=>{r.preventDefault(),s()});const i=r=>{r.code==="Space"&&(r.preventDefault(),s(),document.removeEventListener("keydown",i))};document.addEventListener("keydown",i)}}class V{constructor(e){l(this,"container");l(this,"player");l(this,"spawner");l(this,"particles");l(this,"hud");l(this,"gameOverScreen");l(this,"levelTransition");l(this,"pauseOverlay");l(this,"animationId",0);l(this,"lastTime",0);l(this,"vegetables",[]);l(this,"gameStore",v);this.container=e,this.init()}init(){this.player=new B(this.container),this.spawner=new D(this.container),this.particles=new M(this.container),this.hud=new N(this.container),this.gameOverScreen=new _(this.container,()=>this.restart()),this.levelTransition=new T(this.container),this.pauseOverlay=new P(this.container),v.subscribe(e=>this.handleGameStateChange(e)),this.gameLoop(0),this.setupKeyboardControls()}handleGameStateChange(e){e.gameStatus==="paused"?this.pauseOverlay.show(()=>this.gameStore.getState().resumeGame()):e.gameStatus==="playing"?this.pauseOverlay.hide():e.gameStatus==="won"?(this.levelTransition.show(e.level),setTimeout(()=>{this.gameStore.getState().resetForNextLevel()},2e3)):e.gameStatus==="lost"&&this.gameOverScreen.show(!1,e.score,e.level)}setupKeyboardControls(){document.addEventListener("keydown",e=>{switch(e.key){case" ":case"Escape":e.preventDefault();const t=this.gameStore.getState();t.gameStatus==="playing"?t.pauseGame():t.gameStatus==="paused"&&t.resumeGame();break;case"r":case"R":const s=this.gameStore.getState();(s.gameStatus==="lost"||s.gameStatus==="won")&&this.restart();break}})}gameLoop(e){const t=e-this.lastTime;this.lastTime=e;const s=this.gameStore.getState();s.gameStatus==="playing"?(this.update(t),this.render()):s.gameStatus,this.animationId=requestAnimationFrame(i=>this.gameLoop(i))}update(e){const t=this.gameStore.getState(),s=this.spawner.update(e,t.level);this.vegetables.push(...s),this.vegetables=this.vegetables.filter(r=>{r.y+=r.speed,this.spawner.updateVegetablePosition(r);const n=this.player.getBounds();if(this.checkCollision(n,r)){t.updateScore(r.points),this.particles.createCatchEffect(r.x,r.y),this.spawner.removeVegetable(r.id);const o=this.container.querySelector(".capybara-player");return o&&(o.classList.add("capybara-player--catch"),setTimeout(()=>{o.classList.remove("capybara-player--catch")},500)),!1}return r.y>this.container.clientHeight?(t.incrementMissed(),this.spawner.removeVegetable(r.id),!1):!0}),this.particles.update();const i=this.gameStore.getState();this.hud.updateScore(i.score),this.hud.updateLevel(i.level),this.hud.updateLives(3-i.missedVegetables),this.hud.updateProgress(i.capybaraFillPercentage),this.player.updateFill(i.capybaraFillPercentage)}render(){this.particles.render()}checkCollision(e,t){return t.x<e.x+e.width&&t.x+30>e.x&&t.y<e.y+e.height&&t.y+30>e.y}restart(){this.gameStore.getState().resetGame(),this.vegetables.forEach(e=>{this.spawner.removeVegetable(e.id)}),this.vegetables=[],this.gameOverScreen.hide(),this.hud.updateScore(0),this.hud.updateLevel(1),this.hud.updateLives(3),this.hud.updateProgress(0),this.player.updateFill(0)}destroy(){this.animationId&&cancelAnimationFrame(this.animationId),this.player.destroy(),this.particles.destroy(),this.hud.destroy(),this.gameOverScreen.destroy()}}class Q{constructor(){l(this,"gameEngine",null);l(this,"container");this.init()}init(){this.loadSVGSprites(),this.container=document.createElement("div"),this.container.className="capybara-game",this.showInstructions(),document.body.appendChild(this.container)}loadSVGSprites(){const e=`
    ...
    `,this.container.appendChild(e);const t=e.querySelector("#startGame"),s=()=>{e.remove(),this.startGame()};t.addEventListener("click",s),t.addEventListener("touchend",i=>{i.preventDefault(),s()}),e.addEventListener("touchmove",i=>{i.preventDefault()}),e.addEventListener("click",i=>{i.stopPropagation()})}startGame(){this.gameEngine&&this.gameEngine.destroy(),this.gameEngine=new V(this.container)}}document.addEventListener("DOMContentLoaded",()=>{new Q});window.addEventListener("resize",()=>{const a=document.querySelector(".particle-canvas"),e=document.querySelector(".capybara-game");a&&e&&(a.width=e.clientWidth,a.height=e.clientHeight)});
